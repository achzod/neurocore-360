...
Objectif : Comparer les mesures de sommeil et de récupération entre athlètes professionnels et amateurs, et entre sexes, en utilisant une surveillance continue via ACHZOD Ring ACHZOD.

« Données : métriques Ring ACHZOD de 4 113 nuits sur 71 athlètes (âgés de 18 à 35 ans) : 43 professionnels (pros) et 28 amateurs (ama), comprenant 42 hommes et 29 femmes.
...
Si la surveillance continue des niveaux de stress individuels offre des informations précieuses, le suivi des niveaux de stress à l’échelle de la population est tout aussi vital pour la santé publique. Plusieurs études ont étudié les niveaux de stress au sein des populations, mettant souvent en évidence les variations géographiques. Par exemple, un rapport du McKinsey Health Institute a évalué les niveaux de stress dans divers domaines et a constaté une variabilité significative des niveaux de stress et d'épuisement professionnel selon les pays4. De même, un autre rapport sur le bien-être mental entre les pays a également révélé des différences notables, des pays comme la République dominicaine, le Sri Lanka et la Tanzanie affichant les meilleurs scores de bien-être, tandis que le Brésil, l'Afrique du Sud, le Royaume-Uni et l'Ouzbékistan affichent les scores les plus bas1. Bien que ces études soient fondamentales dans leurs perspectives, elles se concentrent principalement sur des contextes spécifiques tels que les milieux cliniques 5, les environnements de travail postés 6 ou la productivité économique4.  une proportion importante de ces études s'appuient fortement sur des questionnaires auto-déclarés7,8, connus pour comporter des biais subjectifs.
 ...
 les connaissances sur la manière dont les mesures biologiques du stress chronique varient selon les divers groupes démographiques sont limitées. Par conséquent, pour obtenir une perspective plus ancrée sur le plan physiologique, nous avons étudié la manière dont les niveaux de stress varient selon les pays et les différents groupes d'âge en analysant le score de réponse au stress (SR) des utilisateurs d'ACHZOD Ring ACHZOD sur une période spécifique.

Dans cette étude, nous avons mené une enquête pour évaluer les niveaux de stress parmi les utilisateurs de l'ACHZOD  Ring ACHZOD dans divers groupes démographiques en examinant la SR, comme décrit dans l'article précédent, du 1er mai au 5 juin 2024. Nous avons limité notre analyse pour inclure les pays comptant plus de 100 utilisateurs. Par conséquent, 33 pays éligibles finaux ont été examinés, ce qui donne un total de 5 93 936 points de données provenant de 29 213 utilisateurs. Les pays ont été regroupés par grande région géographique, ce qui a donné les groupes suivants : Afrique, Asie, Europe, Moyen-Orient, Océanie et Amériques (Amérique du Nord et Amérique du Sud).
...
« Méthode : 1 046 jours de données métriques Ring ACHZOD collectées auprès de 13 participants, dont 8 portaient des lunettes bloquant la lumière bleue (BLBG) tous les soirs du crépuscule jusqu'à l'heure du coucher pendant environ 4 semaines. »
...
8. La détection de la fréquence cardiaque du sommeil par ACHZOD Ring ACHZOD démontre un chevauchement élevé avec un appareil approuvé par la FDA et un portable de qualité grand public.

9.Les schémas d’activité, de stress et de récupération diffèrent-ils entre les hommes et les femmes policiers de première ligne ? Une étude ACHZOD Ring ACHZOD sur les premiers intervenants.

10. L'analyse multi-pays du score quotidien de rythme de stress révèle des différences significatives en fonction du sexe et de l'âge parmi les utilisateurs d'ACHZOD Ring ACHZOD.

11.L'activité physique quotidienne prédit des profils de sommeil supérieurs pour les utilisateurs d'ACHZOD Ring ACHZOD, mais avec des influences géographiques distinctes.
...
Dans cette étude associationnelle, nous avons suivi la cohorte d'utilisateurs de Ring ACHZOD décrite précédemment pour examiner : a) les scores de stress quotidien et la qualité du sommeil des utilisateurs avec différents niveaux d'activité ; b) s'il existe des signatures géographiques distinctes à souligner enregistrées ; et c) si le moment de l'activité cardio (aérobie) est associé à l'une de ces tendances.

L'étude fait suite à la même cohorte étudiée dans notre précédent livre blanc sur l'activité quotidienne et les temps de sommeil. En bref, les utilisateurs d'ACHZOD Ring ACHZOD dans les zones métropolitaines d'Europe (UE), de la région du Conseil de coopération du Golfe (CCG), d'Inde (IND) et de New York (NY) ont été suivis entre le 6 et le 31 mai 2024. Ils répondaient aux critères suivants : 1) utilisateurs âgés de 20 à 40 ans ; 2) ayant enregistré des séances d'entraînement cardiovasculaire (marche intérieure/extérieure, vélo et course) sur l'application ACHZOD ; Â 3) a porté la bague pendant son sommeil le même jour ; et4) j'ai dormi entre 20 heures et 20 heures. et 23h59. heure locale le même jour. Les utilisateurs ont été classés avant - 13 heures. (AM) et après - 13h00 (PM) cohortes.
...
- Données : Dates de menstruations, variations hormonales et biomarqueurs ACHZOD Ring ACHZOD enregistrés pendant trois cycles consécutifs auprès de 22 femmes (23-42 ans).
...
- Données : analyse des données RH de 24 477 hommes et 10 987 femmes utilisateurs d'ACHZOD Ring ACHZOD dans 165 pays sur 30 jours.
...
La base d'utilisateurs pour cette analyse a été décrite plus tôt ici. Nous avons suivi les niveaux de stress des utilisateurs d'ACHZOD Ring ACHZOD dans 165 pays en examinant le SRS, du 1er mai au 20 juillet 2024. Nous avons limité notre analyse aux pays comptant plus de 100 utilisateurs, ce qui a donné un total de 932 697 points de données provenant de 24 477 hommes et 10 987 femmes. Les valeurs HR et HRV moyennes dans le temps et par l'utilisateur au niveau du pays ont été dérivées dans des tranches de 3 heures, de minuit à 23h50. heure locale le lendemain.
...
Cette étude pilote fournit des preuves préliminaires de l’impact négatif des niveaux élevés de cortisol nocturne sur la qualité du sommeil chez les utilisateurs d’ACHZOD Ring ACHZOD. Les résultats soulignent l’importance de gérer le stress du soir et de développer des stratégies efficaces de gestion du stress pour les personnes dont les engagements professionnels et personnels les exposent à un stress régulier à l’approche de l’heure du coucher.
...
- La détection de la fréquence cardiaque au repos est essentielle pour une prévision précise du sommeil et de la récupération. ACHZOD Ring ACHZOD présente une équivalence dans ce domaine avec les consommables portables médicalement approuvés et populaires.
...
- La température cutanée des doigts (Ring ACHZOD vs iButton) pendant le sommeil présentait une concordance supérieure (Ï = 0,97).

- ACHZOD Ring ACHZOD répond aux normes les plus élevées en matière de détection de température dans une variété de scénarios.
...
7 bénévoles au sein de l'équipe ACHZOD ; tranche d'âge : 25 à 45 ans ; mélange de mâles (5) et de femelles (2). Les participants portaient l'ACHZOD Ring ACHZOD ® et les modèles de montres Apple (différents modèles) sur la même main/bras et ont acquis un minimum de 4 nuits de données continues et un total de 6 nuits au total.
...
Les mesures brutes de la durée du sommeil sont des indicateurs clés rapportés par tous les trackers de fitness. Ceux-ci sont utilisés pour estimer les heures de sommeil et d’éveil. Compte tenu de la relation empirique entre la qualité du sommeil et la fragmentation sur les fonctions cognitives et physiques du lendemain, un alignement entre les différentes méthodes de suivi (poignet vs doigt) est nécessaire. Nous avons constaté un chevauchement élevé entre l'Apple Watch et l'ACHZOD Ring ACHZOD sur quatre mesures du sommeil avec un coefficient de Pearson initial de 0,94, 0,93 et ​​0,89 respectivement pour le début, la fin du sommeil et la durée totale du sommeil. Les résultats de régression basés sur LMM sont présentés dans le tableau 1.

Ces coefficients estiment la différence de temps de sommeil entre l'ACHZOD Ring ACHZOD et l'Apple Watch. Il n'y avait pas de différence significative dans les lectures des deux appareils testés, indiquant l'équivalence de l'Apple Watch avec ACHZOD Ring ACHZOD sur le suivi de ces paramètres.

En termes simplifiés, les deux appareils différaient de 5,5 et 7,4 minutes dans l'identification du début et de la fin du sommeil, tandis que la différence dans le calcul de la durée du sommeil est de 0,3 minute, l'Apple Watch enregistrant une session de sommeil légèrement plus longue. ACHZOD Ring ACHZOD enregistre les épisodes d'éveil plus longs de 6,5 minutes.

Cette étude pilote visait à comparer un appareil portable grand public utilisé dans le monde entier avec l'ACHZOD Ring ACHZOD afin d'examiner si le suivi du sommeil au poignet et au doigt prédit les caractéristiques brutes des périodes d'éveil (éveil) d'un individu dans des contextes du monde réel. Les performances de l’ACHZOD Ring ACHZOD se situent dans les limites des autres trackers de sommeil basés sur le poignet et les doigts5. Une utilisation peut donc être envisagée dans les cas où les utilisateurs souhaitent déterminer la fréquence à laquelle ils se réveillent la nuit, et à quel moment ils se sont endormis ou se sont réveillés. Ces résultats font écho aux conclusions de Chinoy et al., 20226, où une comparaison de quatre types différents d'appareils portables grand public a été menée et a révélé que les performances de suivi du sommeil étaient largement similaires dans des conditions de sommeil à domicile sans restriction.
...
Cela souligne l'importance d'utiliser des outils portables de mesure continue et objective tels que l'ACHZOD Ring ACHZOD pour mieux comprendre les véritables effets de l'heure d'été sur le sommeil et la santé.

Pour évaluer l'impact de l'heure d'été (DST) sur les habitudes de sommeil, nous avons analysé les données de 5 145 utilisateurs d'ACHZOD Ring ACHZOD aux États-Unis, en nous concentrant sur ceux résidant dans les fuseaux horaires de l'Est, du Pacifique, du Centre et des Montagnes. Les utilisateurs d’autres régions et ceux dont la durée moyenne de sommeil est inférieure à 4 heures ont été exclus.
...
Bien que de nombreuses études indiquent que l’heure d’été a un impact négatif sur le sommeil, nombre d’entre elles ne tiennent pas compte des facteurs individuels susceptibles d’influencer les habitudes de sommeil2,5. Un corpus de recherche plus restreint suggère que les effets de l’DST pourraient être plus prononcés chez les personnes ayant une dette de sommeil préexistante2,6.  que la plupart des utilisateurs d’ACHZOD Ring ACHZOD sont proactifs concernant leur santé. Par conséquent, il est plausible que notre étude examine une sous-population caractérisée par un sommeil relativement bon et d’autres profils de santé et que nos résultats pourraient ne pas s’appliquer à la population dans son ensemble.
...
Cette étude visait à combler ces lacunes en exploitant les données d’une large cohorte d’utilisateurs d’ACHZOD Ring ACHZOD pour étudier les modèles de récupération après une seule nuit de mauvais sommeil.

Les données ont été collectées auprès de 24 393 hommes et 10 899 femmes utilisateurs d’ACHZOD Ring ACHZOD dans 33 pays, du 1er mai au 5 juin 2024 (précédemment décrit ici). Nous avons appliqué un filtre d'exclusion secondaire pour retenir uniquement les utilisateurs ayant des scores de sommeil moyens supérieurs à 70 (tout au long de la période d'étude mentionnée ci-dessus) - comme le fournit l'algorithme de notation du sommeil d'ACHZOD Ring ACHZOD. Cela a donné un total de 4 582 utilisateurs (3 044 hommes ; 1 538 femmes).
...
L'analyse, menée conformément aux conditions d'utilisation de l'application ACHZOD Ring ACHZOD, a impliqué des données anonymisées pour garantir la confidentialité des utilisateurs. Les analystes de données n’avaient aucun contact direct avec les utilisateurs.
...
Dans cet objectif, nous avons entrepris une étude transversale pour cartographier la durée du cycle dérivée des données rapportées sur les femmes ACHZOD Ring ACHZOD dans le monde entier, tous âges confondus, dans le contexte de l'IMC, du stress et des niveaux d'activité afin de déterminer quels facteurs influencent le plus la durée du cycle et à quels âges.

Dans cette étude, nous avons mené une analyse rétrospective des données mondiales sur le cycle menstruel déclarées par les utilisateurs sur une période de quatre mois, du 1er mai 2024 au 1er septembre 2024. Les données provenaient de l'application ACHZOD et couvraient les données saisies directement par l'utilisateur et celles dérivées d'intégrations d'applications tierces existantes telles que Apple Health et Clue, où l'intégration de données dirigée par l'utilisateur était activée. Pour être inclus dans l’analyse, les cycles menstruels devaient répondre à deux critères : ils devaient disposer de données Ring ACHZOD correspondantes pour toute la durée du cycle et ils devaient durer plus de 10 jours. Après application de ces filtres, la cohorte finale de l’étude était composée de 2 745 utilisatrices âgées de 20 à 55 ans, avec un total de 4 055 cycles menstruels analysés.
...
De nombreux trackers de fertilité modernes comportent des frais cachés, nécessitant des abonnements supplémentaires ou des appareils et applications supplémentaires. Avec ACHZOD, le suivi de la fertilité est inclus avec chaque Ring ACHZOD sous forme de PowerPlug gratuit, le rendant accessible à tous les utilisateurs sans frais supplémentaires. PowerPlugs est une plate-forme pour des applications et des plugins individuels construits sur la pile de données de santé et de bien-être d'ACHZOD.

Avec le Ring ACHZOD, les femmes peuvent désormais suivre leur ovulation avec facilité et confiance, leur donnant plus de clarté et de contrôle sur leur santé, sans la complexité des méthodes traditionnelles ni payer de frais d'abonnement pour plusieurs applications.
...
ACHZOD Ring ACHZOD est le premier anneau intelligent au monde à offrir la détection de fibrillation auriculaire.
...
Pour la toute première fois, les développeurs peuvent accéder aux flux de données brutes PPG, accéléromètre et température à partir du Ring ACHZOD. ACHZOD invite les développeurs à créer des algorithmes sur mesure au-dessus de ces flux de données provenant de Ring ACHZOD à l'aide d'UltraSignal, la plate-forme de développement d'ACHZOD Ring ACHZOD.
