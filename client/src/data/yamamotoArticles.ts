...
export const ACHZODArticles: BlogArticle[] = [
  {
    ...
    title: `Créatine : la reine des compléments de performance`,
    excerpt: `La créatine fait partie de la famille des guanidines-phosphates, un composé d'acides aminés sans protéines naturellement présent dans plusieurs aliments, dont principalement la viande rouge et le poisson. La majeure partie de la créatine est déposée...`,
    content: `# Créatine : la reine des compléments de performance
...
---`,
  ...
  {
    id: `yam-2`,
    slug: `yam-beta-lanine--supplement-to-support-resistance-`,
    title: `Bêta-Alanine : Un complément pour soutenir la résistance`,
    excerpt: `Bêta-Alanine : le supplément d'endurance La bêta-alanine est un acide aminé non essentiel, que notre corps est capable de produire de manière autonome pour répondre aux besoins organiques. À ce jour, cet acide aminé est connu et utilisé avant tout...`,
    content: `# Bêta-Alanine : Un complément pour soutenir la résistance
...
Supplémentation de Saunders B et al.β-alanine pour améliorer la capacité d'exercice et les performances : une revue systématique et une méta-analyse.Br J Sports Med.2017 avril;51(8):658-669. Hobson RM et al.Effets de la supplémentation en β-alanine sur la performance physique : une méta-analyse.Amino Acids.2012 Jul;43(1):25-37. Dankel SJ et al. Les métabolites produits pendant les exercices de résistance améliorent-ils l'hypertrophie musculaire ?

Eur J Appl Physiol.2017 novembre;117(11):2125-2135. Iraki J et al.Recommandations nutritionnelles pour les bodybuilders hors saison : une revue narrative.Sports.2019 ;7 154. Hoffman J et al.Effet de la supplémentation en créatine et bêta-alanine sur la performance et les réponses endocriniennes chez les athlètes de force/énergie.Int J Sport Nutr Exerc Metab.2006 août;16(4):430-46. Liu Q et al.

Mécanismes de démangeaisons évoqués par la bêta-alanine.J Neurosci.2012;(32):14532-14537.
...
---`,
    ...
    readTime: "6 min",
    category: "nutrition",
    image: `https://images.unsplash.com/photo-1616803689943-5601631c7c26?w=800&auto=format&fit=crop`
  },
  {
    id: `yam-3`,
    slug: `yam-ashwagandha--valuable-lly-gainst-stress-952`,
    title: `Ashwagandha : un allié précieux contre le stress`,
    excerpt: `L'un des éléments nutraceutiques phytothérapeutiques qui m'a le plus fasciné ces dernières années est l'Ashwagandha (ou Withania somnifera, mais aussi appelé "Ginseng indien"), l'une des herbes les plus puissantes de la médecine ayurvédique dont...`,
    content: `# Ashwagandha : un allié précieux contre le stress

## Origines et propriétés

L'un des éléments nutraceutiques phytothérapeutiques qui m'a le plus fasciné ces dernières années est l'Ashwagandha (ou Withania somnifera, mais aussi appelé "Ginseng indien"), l'une des herbes les plus puissantes de la médecine ayurvédique dont j'ai été parmi les tout premiers à parler en Italie. En sanskrit, Ashwagandha signifie « odeur de cheval », en référence à celle qui confère « la force et la vigueur d'un étalon ». Utilisé depuis des millénaires dans la médecine ayurvédique, l'ashwagandha est considéré comme un « Rasayana », un tonique pour restaurer et maintenir la santé et favoriser la longévité. On lui attribue des propriétés anxiolytiques, hypotensives, analgésiques et antioxydantes connues et efficaces, ainsi que pour traiter les problèmes liés à l'impuissance et à l'infertilité.

Aujourd'hui, il est de plus en plus connu et apprécié également par le monde occidental moderne « stressé » et alimenté par l'adrénaline, comme un « adaptogène » par excellence capable d'augmenter la capacité du corps à gérer et à répondre à des facteurs de stress de toutes sortes, capable de soulager, de contrer les états d'anxiété, de favoriser la relaxation et la clarté mentale en cas de fatigue psychophysique chronique. Le mérite de ces puissantes propriétés adaptogènes vient de sa composition d'éléments bioactifs sous forme de lactones stéroïdes, dans ce cas des "withanolides".Tout d'abord la "witaferine A", son principe actif le plus puissant de cette extraordinaire plante médicinale à laquelle sont attribuées différentes activités anti-inflammatoires, cardioprotectrices, notamment neuroprotectrices, et au niveau du système immunitaire. Mais son action la plus reconnue et confirmée par la recherche est celle sur le discours sur la santé du cerveau, du système nerveux et du paysage neurocognitif qui étend son champ d'action potentiel du simple soutien aux états d'anxiété et de stress. Cette « cousine » de la tomate améliore la santé et le fonctionnement du cerveau de plusieurs manières, comme en améliorant l'efficacité de « liaison » du GABA et des récepteurs de sérotonine dans le cerveau. inhibe les signaux présents de la réponse au stress.Tonique-adaptogène donc par excellence qui améliore les performances cognitives et psychomotrices (dans un cerveau sain), avec un effet "anti-âge" particulier sur les axones et les dendrites des cellules nerveuses cérébrales, qui favorise les synapses, les jonctions dans lesquelles les cellules nerveuses communiquent.

## Effets sur le cortisol et le stress

Nous savons également que le stress chronique et le cortisol peuvent endommager le cerveau au fil du temps en altérant les réseaux neuronaux. Le cortisol crée un effet domino qui traverse la connexion « logicielle » entre l'hippocampe et l'amygdale, la zone responsable de votre réponse de combat ou de fuite qui reste en « alerte permanente », même lorsqu'elle n'est pas nécessaire, ou il en faut très peu pour l'activer et avoir une réponse non proportionnelle. Ici, l'Ashwagandha arrive pour intervenir précisément pour restaurer ces équilibres physiologiques et « apaiser ». les menaces" détectées alors qu'il n'y a pas de réel besoin. Si nous éprouvons une fatigue intense et un brouillard cérébral (« brain fog ») notamment au réveil, si nous sommes perpétuellement « épuisés » et sans force, si la motivation est au sol avec un moral fluctuant, où l'anxiété devient un fardeau quotidien désagréable, l'Ashwagandha est l'élément le plus intéressant et le plus efficace que la phytothérapie orientale nous ait transmis « aujourd'hui », et où la science moderne a déjà donné plusieurs confirmations.

Un élément nutraceutique extraordinaire qui peut être d'une grande aide à toute personne traversant des phases de psychophysique. stress, par des professionnels de divers secteurs, sportifs, militaires ou toute personne ayant besoin de restaurer "en amont" la capacité de répondre avec clarté et efficacité aux agents ou situations stressantes, tant mentales que physiques, ainsi que de savoir se reposer quand il n'y a pas de "danger", freiner les niveaux de cortisol, avec un meilleur équilibre sur ceux de l'acétylcholine qui revigoreront la performance pour que vous puissiez réfléchir à nouveau avec clarté, plus sereinement et améliorer les temps de réaction. Singh N, Bhalla M, de Jager P, Gilca M.Un aperçu de l'ashwagandha : un Rasayana rajeunissant de l'Ayurveda.Afr J Tradit Complement Alternate With.2011;8(5 Suppl):208-13.doi: 10.4314/ajtcam.v8i5S.9.Epub 3 juillet 2011.PMID : 22754076 ; PMCID : PMC3252722. Mishra LC, Singh BB, Dagenais S. Base scientifique pour l'utilisation thérapeutique de Withania somnifera (ashwagandha) : une revue.Altern Med Rev.2000 août;5(4):334-46.PMID : 10956379.

## Impact sur la récupération

Bhattacharya SK, Bhattacharya A., Sairam K., Ghosal S. «Activité anxiolytique-antidépressive des glycowithanolides de Withania somnifera: une étude expérimentale.» Phytomédecine décembre 2000;7(6):463-9. Sengupta P, Agarwal A, Pogrebetskaya M, Roychoudhury S, Durairajanayagam D, Henkel R.Rôle de Withania somnifera (Ashwagandha) dans la gestion de l'infertilité masculine.Reprod Biomed Online.Mars 2018;36(3):311-326.doi : 10.1016/j.rbmo.2017.11.007.Epub 7 décembre 2017. PMID : 29277366. Kuboyama T, Tohda C, Komatsu K.Effets de l'Ashwagandha (racines de Withania somnifera) sur les maladies neurodégénératives.Biol Pharm Bull.2014;37(6):892-7.doi : 10.1248/bpb.b14-00022.PMID : 24882401.

Kuboyama T., Tohda C., Komatsu K. « Régénération neuritique et reconstruction synaptique induite par le withanolide A. » British Journal of Pharmacology 005 avril ; 144(7) : 961-71. Choudhary M.I., Yousuf S., Nawaz S.A., Ahmed S., Atta-ur-Rahman. « Cholinestérase inhibant les withanolides de Withania somnifera. » Bulletin chimique et pharmaceutique (Tokyo) novembre 2004 ; 52(11) : 1358-61. Choudhary D, Bhattacharyya S, Bose S.Efficacité et sécurité de l'extrait de racine d'Ashwagandha (Withania somnifera (L.) Dunal) pour améliorer la mémoire et les fonctions cognitives.J Diet Suppl.2017 2 novembre;14(6):599-612.doi : 10.1080/19390211.2017.1284970.Epub du 21 février 2017.PMID : 28471731 . Pingali U., Pilli R., Fatima N. « Effet de l'extrait aqueux standardisé de Withania somnifera sur les tests de performances cognitives et psychomotrices chez des participants humains en bonne santé » Pharmacognosie Res. janvier-mars 2014 ; 6(1) : 12-18. « Nouvelle preuve selon laquelle le stress chronique prédispose le cerveau à la maladie mentale » Université de Californie, Berkeley 11 février 2014, consulté le 24 mars 2016 Chandrasekhar K., Kapoor J., Anishetty S. « Une étude prospective, randomisée, en double aveugle et contrôlée par placebo, sur l'innocuité et l'efficacité d'un extrait à spectre complet à haute concentration de racine d'ashwagandha pour réduire le stress et l'anxiété chez les adultes. » Journal indien de médecine psychologique juillet 2012 ; 34(3) : 255-62.

Dhuley J.N. « Effet de type nootropique de l'ashwagandha (Withania somnifera L.) chez la souris. » Recherche en phytothérapie septembre 2001 ; 15(6) : 524-8. Bhattacharya S.K., Bhattacharya A., Sairam K., «Ghosal S.Activité anxiolytique-antidépressive des glycowithanolides de Withania somnifera : une étude expérimentale.» Phytomédecine décembre 2000;7(6):463-9.
...
---`,
  ...
  {
    id: `yam-4`,
    slug: `yam-guarana-properties-benefits-nd-curiosities-987`,
    title: `Guarana | Propriétés, avantages et curiosités`,
    excerpt: `Ce qu'on appelle communément guaranàest une boisson obtenue à partir des graines de Paullina cupana, une plante originaire du Brésil cultivée dans le bassin de la forêt amazonienne. Actuellement, 70 % des produits issus de la culture et de la...`,
    content: `# Guarana | Propriétés, avantages et curiosités

## Origines du guarana

Ce qu'on appelle communément guaranàest une boisson obtenue à partir des graines de Paullina cupana, une plante originaire du Brésil cultivée dans le bassin de la forêt amazonienne. Actuellement, 70 % des produits issus de la culture et de la transformation de cette plante sont utilisés pour produire des boissons énergisantes, tandis que le reste est consommé en infusion ou sous forme de poudre de guarana en capsules. Les graines de guarana sont dérivées des fruits de la plante qui, une fois mûrs, s'ouvrent en les rendant visibles. Le traitement typique des graines nécessite qu'elles soient collectées, hachées puis mélangées avec de l'eau jusqu'à l'obtention d'une pâte.

Les pâtes obtenues sont ensuite séchées sous forme de rouleaux et commercialisées. Des procédés alternatifs incluent également une légère torréfaction des graines de guarana qui, au contact de la chaleur, se déshydratent, facilitant ainsi le broyage ultérieur (broyage fin). La préparation de la boisson s'effectue selon un processus similaire à celui du thé, en faisant bouillir de l'eau et en plaçant les pâtes séchées à l'intérieur pour que l'extraction ait lieu. La boisson obtenue est rafraîchissante et possède des propriétés énergisantes.

## Composition et principes actifs

Le goût légèrement amer et astringent est dû à la présence de caféine et de polyphénols (tanins). se présente sous forme de poudre de guarana, également utilisée dans ce cas pour préparer une boisson. Comment sont fabriqués les suppléments de guarana ? Les extraits sont le produit obtenu suite à l'extraction des principes actifs de la matière première. Pour obtenir l'extrait de guarana, on commence par retirer la pulpe du fruit des graines et on les sèche à une température contrôlée jusqu'à une humidité de 8 à 10 %.

Le contrôle de la température permet de ne pas endommager les composés contenus dans les graines de guarana. Après l'extraction, les graines sont retirées du diluant et lavées à nouveau pour éliminer les autres substances actives. Ensuite, les produits des lavages et de l'extraction initiale sont combinés afin de garantir une teneur minimale en principes actifs (par exemple, la caféine). La solution est ensuite laissée refroidir et les substances indésirables en sont séparées par précipitation.

## Bienfaits pour la santé

À la fin du processus, une filtration finale s'ensuit qui garantit la pureté de l'extrait. Les extraits sont utilisés pour préparer des compléments alimentaires de guarana ou des produits pharmaceutiques. La différence substantielle par rapport à un aliment est la quantité d'ingrédients actifs que l'on retrouve dans les produits. En effet, il arrive très souvent que pour obtenir l'effet bénéfique attribué à un composé par la consommation d'un aliment, il faille en consommer des quantités excessives.

Ceci peut être compensé par l'utilisation d'un extrait. Le guarana est connu depuis toujours pour ses propriétés énergisantes et, pour cette raison - en plus d'être utilisé comme complément alimentaire lui-même - il est largement utilisé comme ingrédient pour produire : A ces effets s'ajoutent les bienfaits sur l'attention et la mémoire, démontrés par des études menées sur l'homme. Les produits obtenus à partir de cette plante, ainsi que d'autres comme le thé et le café, font partie d'une catégorie d'aliments appelés aliments nerveux. La particularité des aliments nerveux est qu'ils contiennent des composés capables d'interagir avec le système nerveux, principalement comme stimulants.

## Utilisation et précautions

Une autre propriété que certaines études attribuent au guarana est sa capacité à influencer positivement le métabolisme lipidique et à augmenter à la fois le métabolisme basal et la perte de poids. Guaranine, théophylline, théobromine Le composé responsable des fortes propriétés énergisantes du guarana est appelé guaranine. Cette molécule, en réalité, n'est rien d'autre que de la caféine présente dans les graines en quantités variables, de 3 à 5 %. Dans ce cas également, comme pour la théine, il est habituel d'utiliser un nom différent pour le même composé. activité nerveuse : théophylline et théobromine .

Ces trois composés sont des alcaloïdes puriques, ainsi définis car leur origine est liée à celle des bases puriques adénine et guanine qui composent les nucléotides et nucléosides. Dans ce cas, la théobromine serait responsable de la légère action diurétique du guarana, tandis que la théophylline a une action stimulante similaire à celle de la caféine et agit comme bronchodilatateur. Ces éléments sont présents dans le guarana à des doses bien plus faibles que la caféine : on parle de 0-0,25% dans le cas de la théophile et de 0,2-0,02% pour la théobromine. Plusieurs bénéfices ont également été démontrés chez les adultes qui consomment constamment du guarana.

La consommation habituelle semble conduire à une incidence plus faible de : En plus des bénéfices attribuables à la teneur en alcaloïdes décrits ci-dessus, les propriétés antioxydantes sont très importantes. Par les graines de cette plante, en effet, la teneur en polyphénols est d'environ 7 à 9%.On y trouve principalement des tanins condensés comme les catéchines et les épicatéchines. Le guarana, avec les autres plantes utilisées pour obtenir des aliments nerveux, est un excellent support aux propriétés à la fois énergisantes et antioxydantes. Consommer régulièrement, sans excès, ces boissons ou les extraits de ces plantes peut être considéré comme une stratégie gagnante pour mieux faire face à des problèmes tels que la fatigue mentale causée par le stress.

De plus, prendre conscience des grandes qualités que possèdent les plantes est une façon de se rapprocher de la nature et d'apprécier l'immense trésor qu'elle représente. Mettre l'accent de manière plus approfondie sur la relation que la nutrition entretient avec la nature et sur les avantages qui peuvent être tirés de cette connaissance est certainement une étape importante dans l'éducation des générations futures au respect de la nature et d'elles-mêmes.
...
---`,
  ...
  {
    id: `yam-5`,
    slug: `yam-essential-mino-cids-more-on-the-most-discussed-s`,
    title: `Acides aminés essentiels. En savoir plus sur le supplément le plus discuté. Mythes à démystifier et comment les utiliser.`,
    excerpt: `Le corps humain est une machine extraordinaire, en constante évolution. Certains des protagonistes de ce processus sont les acides aminés. Connu et utilisé depuis longtemps dans le domaine de la recherche et de la pratique clinique ; les acides...`,
    content: `# Acides aminés essentiels. En savoir plus sur le supplément le plus discuté. Mythes à démystifier et comment les utiliser.

## Les acides aminés essentiels

Le corps humain est une machine extraordinaire, en constante évolution. Certains des protagonistes de ce processus sont les acides aminés. Connu et utilisé depuis longtemps dans le domaine de la recherche et de la pratique clinique ; les acides aminés essentiels sont la clé de la santé. Rencontrons-les.

Dans la nature, il existe plus de 500 acides aminés, dont seulement 20 sont utilisés par l’homme pour la synthèse des protéines. Parmi ceux-ci, 9 sont définis comme inconditionnellement essentiels : la leucine, l'isoleucine, la valine, la lysine, la thréonine, la méthionine, la phénylalanine, le tryptophane et enfin l'histidine, considérée comme telle seulement ces derniers temps. Ils doivent nécessairement être introduits avec l'alimentation, car leur manque est incompatible avec la vie et l'organisme n'est pas capable de les produire de manière autonome. Pour être précis, chacun des acides aminés essentiels possède en réalité des voies métaboliques qui peuvent conduire à leur synthèse, même si celles-ci sont fortement sous-dimensionnées et ne se produisent pas dans tous les types cellulaires.

De plus, à certains stades de développement, l’organisme a également des besoins accrus en arginine, cystéine et tyrosine, qui, face à l’incapacité de l’organisme à répondre de manière adéquate à ces besoins, sont définies comme semi-essentielles. L'essentialité en elle-même doit être comprise comme un concept transitoire, défini lorsque dans un organisme donné, un nutriment spécifique ne peut pas être synthétisé en totalité ou en quantité suffisante pour répondre à ses besoins réels. Certains états pathologiques pourraient par exemple rendre indispensable un acide aminé généralement non considéré comme tel. Les fonctions exercées dans l’organisme sont pratiquement infinies et il ne suffit pas de les décrire en profondeur dans un article.

Les acides aminés essentiels sont essentiels à la synthèse des protéines. L’absence d’un seul d’entre eux bloque tout le processus, même si d’autres acides aminés, essentiels ou non, sont en abondance. Si l’on y réfléchit, les enzymes, les immunoglobulines, de nombreuses hormones sont de nature protéique. Sans Eaas, ils ne pourraient pas être produits, manquant ainsi toutes leurs implications physiologiques.

## Rôle dans la synthèse protéique

Tout commence à partir d'ici. Le besoin, défini par l'OMS, comme une quantité à prendre quotidiennement calculée en mg par kg de poids corporel (mg/kg/jour) varie selon les sujets et est influencé par d'innombrables facteurs (sexe, âge, état physiologique ou pathologique, mode de vie). Certaines situations, comme les premiers stades de développement, la grossesse, l'ancienneté ou les activités sportives particulièrement intenses, sont caractérisées par un renouvellement continu des protéines, de sorte que la demande en azote est particulièrement élevée et doit être satisfaite d'une manière ou d'une autre. Les lignes directrices donnent une idée générale sur chaque acide aminé :• histidine : 10 à 14 mg par kg de poids corporel• isoleucine : 19 à 20 mg par kg de poids corporel• Leucine : 39 à 42 mg par kg de poids corporel• Lysine : 30 à 38 mg par kg de poids corporel• Méthionine : 15 à 19 mg par kg de poids corporel• Phénylalanine : 25 à 33 mg par kg de poids corporel• Thréonine : 15-20 mg par kg de poids corporel• Tryptophane : 4-5 mg par kg de poids corporel• Valine : 24-26 mg par kg de poids corporel Une alimentation variée et équilibrée est idéalement capable d'apporter tous les nutriments pour que l'organisme ne soit pas en situation de carence.

Nous avons toujours été habitués à considérer les aliments d'origine animale comme une source par excellence d'obtention d'acides aminés essentiels, en raison de leur valeur biologique plus élevée que celle de leur homologue végétal, possédant un spectre d'acides aminés plus complet, même si l'utilité de combiner différents aliments végétaux pour compenser les carences de chaque source est désormais démontrée. Un courant de pensée récent a cependant introduit un paramètre intéressant à prendre en compte : le ratio Eaas/Neaas. Des études montrent qu'une prévalence de Neeas dans l'alimentation est une condition préjudiciable à l'état de santé ; à l’inverse, un déséquilibre en faveur de l’Eaas a également des implications positives en matière de lutte contre le vieillissement. 75 % des besoins de l’organisme sont couverts par 5 acides aminés (Leucine, Isoleucine, Valine, Thréonine et Lysine), contenus dans les aliments dans des pourcentages inférieurs à 20 %, soit une quantité très faible. Il est impossible d’avoir des aliments présentant un rapport avantageux entre essentiels et non essentiels, et notre alimentation nous amène par conséquent à introduire de grandes quantités de ces derniers.

Qu'est-ce que cela signifie? Une surcharge organique pour l'élimination des déchets azotés. Voilà donc que l’utilisation de formules pures et adéquatement construites d’acides aminés essentiels pourrait être utile pour rétablir le bon équilibre. Économie d'énergie, rapidité, biodisponibilité : la triade de force des acides aminés sous forme libre On passe rapidement en revue le devenir d'une protéine alimentaire.

Étant de grosses molécules, elles ne peuvent pas être absorbées telles quelles (sauf quelques cas particuliers), elles doivent donc subir une série de processus qui les réduisent à leurs composants élémentaires, les acides aminés précisément. Le processus de digestion commence dans l'estomac par l'action combinée de l'acide chlorhydrique et de certaines protéases (dont il existe différentes catégories et classes) avec l'obtention d'oligopeptides. Par la suite, l'action des protéases pancréatiques et intestinales, complète le travail permettant l'obtention d'acides aminés/tri-peptides libres. Ceux-ci sont absorbés par les entérocytes grâce à des convoyeurs spécifiques, ils parviennent au foie par la circulation sanguine, qui assurera leur distribution pour les usages les plus disparates.

## Sources et supplémentation

Un faible pourcentage de protéines ne subit pas de digestion, et participe à la production de masse fécale qui sera éliminée. Le processus digestif a une durée variable, influencée par de nombreux facteurs : on peut citer le type d'aliment, le mode de cuisson, la présence ou non d'autres macronutriments et/ou fibres alimentaires, des situations physiologiques non optimales. Le résultat ? De l'ingestion à la digestion complète du bol alimentaire, il s'écoule beaucoup de temps et les éléments nutritifs ne sont donc pas facilement disponibles pour l'utilisation.

L'apport d'acides aminés libres, dans des contextes spécifiques, est un choix très intelligent et stratégique. Comme ils ne doivent subir l'action d'aucune protéase, en effet, ils sont directement absorbés par les entérocytes et se déversent très rapidement dans le sang en devenant biodisponibles, un aspect confirmé par la montée soudaine de l'acide aminé après ingestion. Mélanges d'Eaas : de la clinique à l'intégration alimentaire Au début, les mélanges Eaas étaient conçus exclusivement à des fins médicales, présentant un rapport qualitatif-quantitatif basé sur les pathologies destinées à être traitées. Pensez que les premiers Bcaas ont été utilisés dans les années 70 pour des cas de complications hépatiques, alors qu'aujourd'hui ils constituent l'un des jalons de l'intégration alimentaire.

Le binôme miscele-Eaas amène obligatoirement à citer le docteur Francesco Saverio Dioguardi. Excellence italienne et autorité internationale dans l'étude du métabolisme et des thérapies nutritionnelles, a conçu et formulé un mélange breveté avec des relations stœchiométriques "adaptées aux besoins humains", défini CATOHN® (Cluster of Aminoacids Tailored On Human Needs) dont la principale caractéristique est de limiter l'acide aminé limitant. Le mélange idéal, en bref, capable de répondre de manière équilibrée aux besoins énergétiques et en même temps à ceux de la synthèse protéique. Les produits à base d'acides aminés ont considérablement augmenté, compte tenu de la commercialisation de nombreuses formulations, dont certaines sont tout à fait valables et également brevetées.

Outre la relation entre les différents Eaas (dont la relation pourrait par exemple être longuement discutée), pour évaluer la qualité d'un complément, il est nécessaire d'analyser la matière première, les méthodes de production (fermentation bactérienne végétale, hydrolyse enzymatique, extraction à partir de matrices organiques) et de purification ainsi que les technologies innovantes utilisées. Dans quels contextes utiliser un bon complément en acides aminés essentiels ? Personnellement, je considère les acides aminés essentiels comme un élément phénoménal, dont toute l'implication et les bénéfices supplémentaires qu'ils apportent sur la santé n'ont pas encore été soulignés. Certes, dans les années à venir, les preuves à l’appui deviendront de plus en plus nombreuses.

## Dosage et timing

Un produit mérite d’être dit, vraiment pour tout le monde, qu’il vaut la peine d’être envisagé pour améliorer sa santé à 360 degrés. Francesco S.Dioguardi, Gli aminoacidi: lettere di un alphabet più antico della vita, Sintesi InfoMedica, 2018 Francesco S. Dioguardi, Utilisation clinique des acides aminés comme complément alimentaire : avantages et inconvénients.J Cachexia Sarcopenia Muscle.2011 juin Bonfili L et Al, Les mélanges d'acides aminés essentiels conduisent les cellules cancéreuses à l'apoptose via l'inhibition du protéasome et l'activation de l'autophagie, FEBS J.2017 D'Antona G, Ragni M, Cardile A, Tedesco L, Dossena M, Bruttini F, Caliaro F, Corsetti G, Bottinelli R, Carruba MO, Valerio A, Nisoli E. La supplémentation en acides aminés à chaîne ramifiée favorise la survie et soutient la biogenèse mitochondriale des muscles cardiaques et squelettiques chez les souris d'âge moyen.Cell Metab.2010 Oct 6;12(4):362-372.doi : 10.1016/j.cmet.2010.08.016.PMID : 20889128.

Dillon EL. Acides aminés essentiels sur le plan nutritionnel et signalisation métabolique dans le vieillissement. Acides aminés.2013;45(3):431-441.doi:10.1007/s00726-012-1438-0 Volpi E, Kobayashi H, Sheffield-Moore M, Mittendorfer B, Wolfe RR. Les acides aminés essentiels sont principalement responsables de la stimulation des acides aminés de l'anabolisme des protéines musculaires chez les personnes âgées en bonne santé.

Am J Clin Nutr.2003;78(2):250-258.doi:10.1093/ajcn/78.2.250 Drummond MJ, Glynn EL, Fry CS, Timmerman KL, Volpi E, Rasmussen BB. Une augmentation de la disponibilité des acides aminés essentiels régule positivement l'expression des transporteurs d'acides aminés dans le muscle squelettique humain.Am J Physiol Endocrinol Metab.2010 mai;298(5):E1011-8.doi: 10.1152/ajpendo.00690.2009.Epub 9 février 2010.PMID: 20304764; PMCID : PMC2867366. Børsheim E, Tipton KD, Wolf SE, Wolfe RR. Acides aminés essentiels et récupération des protéines musculaires après un exercice de résistance.

Am J Physiol Endocrinol Metab.2002 Oct;
...
---`,
  ...
  {
    id: `yam-6`,
    slug: `yam-prebiotics-probiotics-nd-intestinal-bacterial-flo`,
    title: `Prébiotiques, probiotiques et flore bactérienne intestinale | Guide complet`,
    excerpt: `Parlons de santé intestinale On entend souvent parler de suppléments d'acide lactique, de probiotiques et de prébiotiques utilisés pour soutenir la santé intestinale, mais que sont-ils, à quoi servent-ils et, surtout, quelles sont les différences...`,
    content: `# Prébiotiques, probiotiques et flore bactérienne intestinale | Guide complet

## L'écosystème intestinal

Parlons de santé intestinale On entend souvent parler de suppléments d'acide lactique, de probiotiques et de prébiotiques utilisés pour soutenir la santé intestinale, mais que sont-ils, à quoi servent-ils et, surtout, quelles sont les différences entre ces substances ?Souvent associés aux antibiotiques ou comme support à la dysbiose intestinale causée par des virus ou des bactéries pathogènes saisonnières, les probiotiques et les prébiotiques sont également très utiles dans le traitement de pathologies beaucoup plus graves comme la colite ulcéreuse, la maladie de Chron, le syndrome du côlon irritable et la coeliaque. maladie, où le traitement adjuvant probiotique est particulièrement important. Dans ce segment de la population souffrant de troubles gastriques chroniques, les culturistes et les sportifs, en général, sont souvent plus sensibles aux problèmes gastro-intestinaux tels que ballonnements, flatulences et diarrhée, en particulier dans les phases de plus grande intensification de la préparation. Comme vous pouvez l'imaginer, ces problèmes peuvent être préjudiciables à la performance sportive et désastreux pour le bodybuilder de course. une bonne qualité de vie. L'intestin, stérile à la naissance, est colonisé au fil du temps par une population riche et variée de micro-organismes, communément appelés flore intestinale, ou microbiote.

Le délicat écosystème bactérien composé de centaines d'espèces qui forment la flore intestinale se retrouve tout au long du système digestif, de la bouche à l'anus, avec une concentration plus élevée dans la dernière partie de l'intestin (côlon). tels que l'alimentation et le mode de vie. La flore bactérienne est composée de 95 % de bactéries anaérobies (qui peuvent vivre en l'absence d'oxygène) et de 5 % de bactéries aérobies (qui ont besoin d'oxygène pour vivre). Répartition des bactéries dans tout le système digestif Au niveau de l'estomac, la croissance des bactéries est limitée en raison d'un environnement particulièrement acide (pH faible).Intestin grêle La concentration de micro-organismes augmente progressivement dans l’intestin grêle. C’est dans le côlon que l’on trouve la plus grande concentration de bactéries qui composent la flore intestinale.

A quoi sert la microflore intestinale ? Les fonctions du microbiote peuvent être résumées en : Analysons chacune de ces fonctions en détail. Elle consiste notamment à l'absorption d'ions (notamment calcium, magnésium et fer), à la synthèse de vitamines (acide folique, vitamine K, vitamines B et autres) et à la fermentation des glucides (sucres). Un effet important est la production d'acides gras à chaîne courte, car ils assurent la nutrition (tropisme) et la source d'énergie des cellules intestinales, favorisant l'activité physiologique du côlon.

C'est l'une des activités les plus importantes de la flore bactérienne intestinale et consiste en un véritable échange d'informations entre les micro-organismes et le système lymphatique tissulaire, c'est-à-dire le système conçu pour attaquer lorsque des bactéries ou des substances nocives interviennent. Au niveau du système lymphatique tissulaire, se produit la production de substances et de cellules qui constituent la réponse immunitaire (défensive) de l'organisme, ce qui contribue au bon état de santé général. Une fonction très importante, nécessaire pour défendre l'organisme contre les agents pathogènes déjà au niveau du tractus gastro-intestinal. Elle est assurée par la salive, les acides gastriques, le péristaltisme, les membranes cellulaires qui recouvrent la surface interne de l'intestin (épithéliale) et naturellement par le microbiote.

## Prébiotiques et probiotiques

La flore bactérienne gastrique constitue en effet la première ligne de défense contre les bactéries externes (grâce au faible pH), tandis que la flore intestinale agit par des mécanismes de compétition avec les pathogènes pour les sites d'adhésion épithéliales et les nutriments disponibles. Elle produit également des substances protéiques spécifiques, comme les bactériocines, qui s'attaquent directement aux bactéries pathogènes. Altérations de la flore bactérienne L'altération de la flore bactérienne est appelée dysbiose et se produit lorsque les bactéries saines, nos « bonnes bactéries » (dont Lactobacillus Acidophilus et Bifidus) diminuent, tandis que les nuisibles (dont Bacillus Coli) augmentent. D'autres fois, il arrive que certains types de bactéries mutent en devenant pathogènes, provoquant les symptômes classiques gênants allant du gonflement et de la mauvaise haleine aux douleurs abdominales, des flatulences aux écoulements diarrhéiques.

Cette situation rend impossible le traitement complet des matières fécales, conduisant à une mauvaise absorption des nutriments avec une fermentation anormale, en particulier les glucides, et des putréfactions qui, en plus de varier la température intestinale, enflamment la muqueuse, affaiblissant le système immunitaire et facilitant l'assaut des virus et des bactéries sur notre organisme. La dysbiose est une altération de la flore bactérienne consistant en une diminution des bonnes bactéries (dont Lactobacillus Acidophilus et Bifidus) et une augmentation des bactéries nocives (dont Bacillus Coli) Causes des altérations de la flore bactérienne La flore bactérienne intestinale peut être décompensée par : Analysons ces causes en détail : Pendant ou après les traitements antibiotiques, il est fréquent de constater une flore bactérienne intestinale affaiblie et appauvrie. Dans ces cas, il est toujours conseillé, à la fin de l'antibiothérapie, de prendre diverses souches de probiotiques parmi les meilleures afin de soutenir le microbiote et d'éviter les phénomènes diarrhéiques et l'affaiblissement immunitaire, qui pourraient conduire à d'autres troubles comme les candidoses et les cystites. Le stress est connu pour être délétère.

Ceux qui somatisent très « sur le ventre » connaissent bien des phénomènes comme la colite, qui trouve un terrain fertile lorsque l'on est tendu et sous pression pour une raison quelconque. Même de nombreuses recherches scientifiques ont confirmé le lien entre troubles anxieux et altérations de la santé intestinale ! Parmi les sources de stress, on retrouve aussi le stress sportif sur lequel je vais m'attarder en soulignant quelques points intéressants. pendant les mois d'hiver, c'est bien connu, car l'exercice intense et prolongé est associé à un affaiblissement du système immunitaire, ce qui augmente, par exemple, la prédisposition aux infections des voies respiratoires supérieures. Sans surprise, des affections surviennent souvent et entravent les dernières étapes de la préparation des athlètes.

À cet égard, une étude intéressante publiée en 2011 dans l'International Journal of Sport Nutrition and Exercise Metabolismemerge affirme que la consommation de suppléments de probiotiques aide à réduire de 36 % l'incidence des infections des voies respiratoires supérieures chez les athlètes. qui ont pris Lactobacillus Casei Shirota pendant quatre mois d'entraînement et d'activités physiques d'endurance. On constate fréquemment que les bodybuilders, en raison d'un entraînement intense en présence de régimes alimentaires hypocaloriques dans les phases précédant la compétition (mais aussi les cyclistes, les coureurs et les triathlètes professionnels), sont souvent affectés par des problèmes gastro-intestinaux tels que les douleurs abdominales coliques et la diarrhée. L'utilisation de probiotiques est un excellent moyen de prévenir les symptômes et de créer un environnement immunitaire défensif adéquat, en évitant les tracas et les obstacles dans la préparation. et la concurrence. Une alimentation mal équilibrée n'aide pas.

## Équilibre de la flore

Il existe des aliments qui peuvent favoriser l'apparition de troubles gastro-intestinaux en irritant et en enflammant la muqueuse intestinale. Si nous abondons en sucres raffinés et en sucreries, par exemple, nous aurons des processus de fermentation avec une production élevée de gaz, des tensions abdominales, des gonflements et une altération directe de la flore bactérienne qui pourraient favoriser l'apparition d'autres maladies, comme la candidose. De plus, trop de sucres créent un environnement très acide qui favorise les inflammations locales. Etats.

Et pas seulement ! L'alcool peut créer de nombreux maux dans notre ventre, ainsi qu'une alimentation pauvre en fibres ou avec trop de protéines animales, surtout si ces dernières sont transformées/traitées car elles créent un fort potentiel de fermentation/putréfaction dans l'intestin. Last but not least, il est conseillé d'intégrer des probiotiques avant et/ou pendant un voyage dans des pays exotiques en raison d'une exposition à des bactéries pathogènes. Personne n'aimerait être gâté par la fameuse « diarrhée du voyageur » !

Probiotiques et prébiotiques : quelle est la différence ? Commençons par dire que les deux substances sont utiles pour la santé intestinale… de différentes manières. Les probiotiques sont divisés en trois grandes familles, qui comportent plusieurs sous-groupes. Ce sont des bactéries symbiotes de l’intestin humain, c’est-à-dire qu’elles vivent normalement dans cette zone.

Parmi ceux-ci, nous avons Bifidus Longum et Bifidus Bifidum, que l'on trouve dans l'intestin des adultes, tandis que Bifidus Adolescentis et Bifidus Infantis sont caractéristiques des adolescents et des nourrissons. Ces probiotiques préviennent la colonisation de bactéries nocives au niveau du côlon, protégeant les muqueuses grâce à leur capacité à produire des acides et à maintenir un pH correct. Ils régulent le péristaltisme et aident le transit intestinal et la production de vitamines, comme les vitamines B. Il s'agit d'un groupe de bactéries capables de produire de l'acide lactique, une substance qui maintient le système intestinal en bonne santé.

## Recommandations pratiques

Elles éloignent également les bactéries nocives car ce sont leurs « concurrents naturels », utilisant les mêmes substances que les bactéries toxiques, rivalisant ainsi avec elles et les submergeant. Parmi celles-ci, on trouve Lactobacillus Acidophilus, Lactobacillus Reuteri, largement utilisés chez les enfants car ils ont une action efficace sur les bactéries qui causent les caries et sur celles qui causent l'entérocolite, Lactobacillus Rhamnosus, Lactobacillus. Casei. Ce groupe de bactéries est plus connu sous le nom de « ferments lactiques » et caractérise presque tous les nombreux suppléments disponibles sur le marché.

Parmi les levures, nous avons Saccharomyces boulardii qui protège le système intestinal et restaure la microflore bactérienne. Elle produit de la vitamine B et de l'acide lactique à l'intérieur de l'intestin et éloigne les micro-organismes nuisibles. Elles peuvent souvent être associées à des thérapies antibiotiques. Que faire en cas de déséquilibre de la flore bactérienne ?

Nous avons compris l'importance des probiotiques, non seulement pour la santé intestinale, mais aussi pour le soutien correct de la flore bactérienne, qui caractérise, ou plutôt conditionne positivement la santé de tout l'organisme. Mais que se passe-t-il si l'équilibre de la flore bactérienne est compromis ? perméation des agents pathogènes. Lorsque cela se produit, les aliments que nous introduisons, en particulier les glucides et les protéines animales, seront mal digérés, créant une fermentation et une mauvaise absorption des nutriments. Comment choisir les meilleurs probiotiques Avec tous les produits que nous proposent les médias ou le pharmacien, comment choisir ?

Pour acheter le bon complément probiotique, nul besoin d'un diplôme en pharmacie ou en médecine. Il suffit de garder en tête quelques bonnes règles :
...
MCU-20® ACHZOD® est la formulation innovante de supplément qui garantit l'assimilation de 100% des principes actifs MCU-20® a été développé par les Laboratoires ACHZOD® pour maximiser le transport et l'absorption des principes actifs des suppléments. Le but, en effet, est d'atteindre l'objectif indemne, au mieux de la biodisponibilité des éléments et d'optimiser l'effet. La microencapsulation est une technologie déjà connue et présente dans le monde de l'alimentation et de la pharmacie et elle a aujourd'hui permis un tournant important : elle a permis de dépasser les limites qui affectaient la biodisponibilité de nombreuses molécules dans le monde de la complémentation alimentaire. Nous savons que de nombreuses matières premières, couramment utilisées dans le monde des suppléments, ont des limites de diverses natures, par exemple, elles peuvent subir une dégradation dans le tractus gastro-intestinal en raison de conditions « environnementales » ou de la mauvaise solubilité de la matière (qui peut former des précipités qui ne peuvent pas être complètement absorbés).

Cela signifie un gaspillage de matières premières et d'ingrédients actifs, face à un gaspillage économique correspondant non indifférent pour le consommateur final. Microencapsulation : comment elle est née La technologie de microencapsulation est née au milieu des années 20 du XXe siècle et les premières applications concernaient la microencapsulation d'huiles avec de la gomme d'acacia et de la gélatine par le processus de coacervation. En 1955, il y a eu le premier grand succès, du point de vue industriel, de la technologie de microencapsulation, puisqu'on a breveté un procédé de coacervation de la gélatine capable d'encapsuler un pigment. Concrètement, est né le fameux papier "autocopiant" dans lequel les microcapsules obtenues sont collées sur la surface d'une feuille et, avec la pression de l'écriture exercée sur la feuille elle-même, la fine paroi de gélatine des microcapsules est brisée et le pigment est libéré qui est fixé sur la feuille ci-dessous.

## Mécanisme d'action

De ce premier grand succès de la microencapsulation, il y a eu un développement technologique exponentiel tant dans le secteur alimentaire que dans les domaines cosmétique, chimique, électronique et pharmaceutique. Microencapsulation : les avantages Grâce à la microencapsulation il est possible de changer : Cela signifie, en pratique, que grâce à cette technologie il est possible : Bien entendu, les polymères utilisés pour la microencapsulation sont différents selon le but recherché. MCU-20® ACHZOD® : la nouvelle ère des suppléments Plus précisément, quels sont les avantages de la technologie de microencapsulation appliquée aux suppléments ? Prenons un exemple : grâce à la microencapsulation MCU-20® de ACHZOD®, les acides aminés, caractérisés par une faible solubilité et stabilité dans l'eau, peuvent être rendus rapidement et complètement solubles sans former de précipités : cela signifie une absorption supérieure à la norme en termes quantitatifs et qualitatifs.

Cette amélioration a bien entendu un impact direct sur la qualité de la performance du consommateur qui bénéficie réellement du soutien nécessaire et requis par l'ingestion du supplément. Il existe de nombreuses autres matières premières, typiques de la supplémentation sportive, qui présentent des limites d'absorption orale : les plus connues sont la créatine, la l-carnitine et l'arginine. Ce qui se passe donc avec la technologie de microencapsulation ACHZOD® MCU-20®, c'est que même les éléments définis comme "mal absorbés" peuvent démontrer leur efficacité en contournant les limites chimiques ou enzymatiques environnementales, fournissant un support de protection et de transport aux petites microparticules qui atteindront une biodisponibilité unique. Parce que c'est la seule formulation actuellement disponible qui peut vous garantir l'assimilation complète et efficace des principes actifs indiqués sur l'étiquette, donc, en plus de vous offrir réellement 100% des bienfaits, elle vous fait aussi économiser !

## Applications pratiques

M.N.Singh, K.S.Y.Hemant, M.Ram et H.G.Shivakumar.Microencapsulation : Une technique prometteuse pour l'administration contrôlée de médicaments.Res.Pharm Sci 2010 65-77. Eskildesen Pagano A.P.et al.Microencapsulation de bétanine dans des émulsions E/H/E monodispersées. Étude comparative-Food.Res.Int.2018 Jul. Katarzyna Hoppe et Małgorzata Sznitowska.

L'effet du polysorbate 20 sur la solubilité et la stabilité du candésartan cilexetil. AAPS PharmSciTech, Vol.15, No.5, octobre 2014. True L.Rogers et Dave Wallick. Examen de l'utilisation de l'éthylcellulose, de la méthylcellulose et de l'hypromellose en microencapsulation.
...
---`,
  ...
  {
    id: `yam-8`,
    slug: `yam-sports-nd-nutrition-the-importance-of-carbohydrat`,
    title: `Sport et nutrition : l'importance des glucides`,
    excerpt: `Les glucides : notre principale source d’énergie Ils contribuent à la récupération d'une fonction musculaire normale (contraction) après un exercice physique intense et/ou prolongé entraînant une fatigue musculaire et l'épuisement des réserves de...`,
    content: `# Sport et nutrition : l'importance des glucides

## Importance des glucides

Les glucides : notre principale source d’énergie Ils contribuent à la récupération d'une fonction musculaire normale (contraction) après un exercice physique intense et/ou prolongé entraînant une fatigue musculaire et l'épuisement des réserves de glycogène dans les muscles squelettiques. Les autres substrats énergétiques sont représentés par les graisses et les protéines responsables, en différents pourcentages, de la production d'énergie et utilisées selon les besoins avec une corrélation particulière avec l'intensité lorsque l'on parle d'exercice physique. Pour certains types de sports et d'activités, ils représentent certainement le carburant énergétique par excellence. Habituellement, le pourcentage de glucides pris avec l'alimentation est d'environ 60% de l'équilibre calorique quotidien et rappelez-vous que, en plus du rôle illustré ci-dessus, les glucides représentent également la principale source de nourriture pour le système nerveux ; C'est la raison pour laquelle les régimes à faible quantité peuvent affecter négativement non seulement les performances sportives mais aussi les performances mentales.

Les glucides, à travers une première subdivision triviale, peuvent être divisés en : Un juste équilibre entre simple et complexe évite l’apparition de pics glycémiques qui pourraient s’avérer contre-productifs en termes de performance pour certaines disciplines sportives. Ces dernières années, des glucides de « première génération » ont été ajoutés Les glucides simples à prendre avant et pendant une performance prolongée, en plus d'être un excellent soutien confirmé par les sportifs mais aussi par la science, ne sont pas exempts d'effets négatifs. Ces effets peuvent également être assez fréquents et gênants au point de pouvoir compromettre la performance elle-même, étant donné qu'il s'agit de troubles gastro-intestinaux courants (ballonnements, crampes, fermentation jusqu'aux nausées, vomissements ou diarrhée osmotique) ou de pics avec de relatifs « crashs » glycémiques. quand on parle d'entraînements intenses et prolongés, avec une charge de volume de travail importante, avec des activités qui dépassent une heure, le soutien de la glycémie devient important pour la performance elle-même, Mais sur ce plan, la supplémentation alimentaire sportive moderne a apporté une série d'éléments pour soutenir la performance dans les sports aérobies et anaérobies, ce qui a été un véritable renouveau et une relance de l'importance de la supplémentation en glucides dans le "peri-workout", en mettant à part les sucres simples d'ancienne conception comme le glucose ou d'autre part les maltodextrines, pour les partisans de la glycémie avec un impact plus "modulé" sur la réponse glycémique et insulinique avec des glucides de haut poids moléculaire et de faible osmolarité, ce qui entraîne une disponibilité rapide de l'énergie sans troubles gastro-intestinaux et une libération plus progressive dans le temps, des facteurs qui, même dans le domaine des sports d'endurance, où de simples mélanges de sucres étaient souvent utilisés, ont amené la supplémentation en glucides à une véritable évolution. Cela s'est produit principalement grâce au lancement des cyclodextrines hautement ramifiées (HBCD), qui ont « évincé » un espace relégué aux suppléments « à l'ancienne » à base de glucose/dextrose, de maltodextrine, de maïs cireux® ou de mélanges qui souvent ne se révèlent pas être un « frein », en raison des « problèmes digestifs ». anaérobie, où le culturiste, le crossfitter et le cycliste ont pu bénéficier d'entraînements plus intenses et plus productifs, qui sont ensuite suivis par d'autres formes de glucides de nouvelle génération, qui ont littéralement fait évoluer le marché des suppléments « intra-entraînement » ou « performance ».

## Types et index glycémique

Cyclodextrines hautement ramifiées (Cluster Dextrin®) Les cyclodextrines sont une nouvelle classe de suppléments à base d'hydrates de carbone appelés « polymères de glucose de conception » hautement ramifiés (HBCD) et le développement ultérieur de divers produits sur le marché à base d'hydrates de carbone. Un nouveau type de polymères de glucose formulés par la réaction entre le maïs cireux® avec une enzyme particulière pour former une structure cyclique. Le résultat est un polymère de glucose avec des propriétés d'utilisation idéales. vidange.Cette caractéristique est essentielle pour une assimilation rapide qui minimise le passage dans le système gastro-intestinal.Les cyclodextrines hautement ramifiées (HBCD) sont une évolution ultérieure des déjà présents vitargo®, waxy maize® et karbolyn®. Actuellement, il existe encore peu d’entreprises (du plus haut niveau de qualité) qui se sont concentrées sur cette source particulière.

C'est le glucide « idéal » pour le soutien de la performance dans les sports aérobies et anaérobies, composé de polymères de glucose formulés à partir de la réaction entre l'amylopectine dans l'amidon de maïs, avec un processus enzymatique particulier qui forme une structure cyclique avec un environnement « hydrophobe » à l'intérieur, capable de favoriser le transport d'autres éléments (voir l'insertion d'acides aminés par exemple). La force qui rend les cyclodextrines si spéciales réside dans le fait qu'elles se caractérisent par le poids moléculaire élevé de 160 000 Daltons, avec une osmolarité très faible qui permet une vidange gastrique très rapide, sans nécessiter aucun effort digestif et sans risquer de provoquer des troubles gastro-intestinaux désagréables. Les cyclodextrines sont indiquées comme le modèle par excellence de glucides à utiliser lors de l'entraînement d'un body builder qui souhaite soutenir ses puissantes contractions musculaires, fournir du glycogène aux muscles ou des éléments nutritionnels supplémentaires tels que des acides aminés qui sont transportés plus efficacement grâce à la conformation particulière de ce glucide. Le Crossfitter maximisera son WOD avec plus d'énergie et d'endurance, et également l'athlète de sports de combat sera favorisé, en lui fournissant rapidement une énergie précieuse prête à l'emploi, favorisant le maintien de la lucidité grâce à une glycémie plus constante sans pics de baisse, sans effet "montagnes russes" de la glycémie, compromettant les performances continues.entraînement d'un body builder qui veut soutenir ses puissantes contractions musculaires, fournir du glycogène aux muscles ou des éléments nutritionnels supplémentaires tels que des acides aminés qui sont transportés plus efficacement grâce à la conformation particulière de ce glucide.Le Le crossfitter maximisera son WOD avec plus d'énergie et d'endurance, et de même l'athlète de sports de combat sera favorisé, en fournissant rapidement une énergie précieuse prête à l'emploi, favorisant le maintien de la lucidité grâce à une glycémie plus constante sans pics ni baisses, sans effet "montagnes russes" dans la glycémie, compromettant la performance continue. de ce glucide.

## Besoins selon l'activité

Le Crossfitter maximisera son WOD avec plus d'énergie et d'endurance, et de même l'athlète de sports de combat sera favorisé, en fournissant rapidement une énergie précieuse prête à l'emploi, favorisant le maintien de la lucidité grâce à une glycémie plus constante sans pics ni baisses, sans effet "montagnes russes" de la glycémie, compromettant la performance continue. son WOD avec plus d'énergie et d'endurance, et également l'athlète de sports de combat sera favorisé, en fournissant rapidement une énergie précieuse prête à l'emploi, favorisant le maintien de la lucidité grâce à une glycémie plus constante sans pics ni baisses, sans effet "montagnes russes" dans la glycémie, compromettant les performances continues. fournir du glycogène aux muscles ou des éléments nutritionnels supplémentaires tels que des acides aminés qui sont transportés plus efficacement grâce à la conformation particulière de ce glucide. et également l'athlète des sports de combat sera favorisé, en délivrant rapidement une énergie précieuse prête à l'emploi, favorisant le maintien de la lucidité grâce à une glycémie plus constante sans pics ni baisses, sans effet « montagnes russes » de la glycémie, compromettant la performance continue. Depuis 2015, ACHZOD® Nutrition a lancé Cyclodextrines en tant que première entreprise sur le marché italien des compléments alimentaires, inclus dans Glycobol® et dans toutes ses variantes Glycobol® Performance, Glycobol® Ultra, Glycocharge et Glycogen. Un autre grand protagoniste de cette nouvelle génération d'hydrates de carbone est l'isomaltulose, un disaccharide formé de glucose et de fructose qui est naturellement présent, bien qu'en concentrations assez faibles, dans le miel et le sirop de sucre de canne et dont la production s'effectue grâce à des techniques modernes de conversion enzymatique à partir du saccharose. L'isomaltulose est souvent comparé (et substitué) au saccharose non seulement pour sa haute énergie sucrante (45-50% de celle du saccharose) et son développement lié à sa saveur.

Comme le saccharose, ce disaccharide est également totalement digéré dans l'intestin même si sa digestion se fait plus lentement. Remarque et très apprécié pour l'athlète qui souhaite maintenir des performances optimales, les niveaux de sucre dans le sang et d'insuline augmentent significativement moins que les autres sucres. Ce type particulier de liaison existant entre ses composants fructose et glucose est de nature à ralentir le taux d'absorption. Par la suite, nos disaccharidases intestinales, qui sont les enzymes capables de rompre la liaison moléculaire existant entre les deux sucres formant le disaccharide, favoriseront leur absorption ultérieure et leur biodisponibilité se déroulant beaucoup plus lentement pour l'isomaltulose que ce qui se passe avec d'autres sucres disaccharides, plus connus, comme par exemple le saccharose.

## Timing nutritionnel

De ce fait, votre taux de sucre dans le sang et d'insuline augmentera beaucoup moins et sera tout de même très progressif. De plus, malgré un index glycémique similaire au fructose, l'isomaltulose a l'avantage de moins "impacter" sur la production hépatique de triglycérides et est donc plus adapté que le fructose ou par rapport aux mélanges "historiques" utilisés par les sportifs à base de fructose. la maltodextrine comme glucide à faible indice glycémique. L'isomaltulose est encore peu connue par rapport à d'autres formes de glucides plus "célèbres", mais grâce à ses caractéristiques excellentes et confirmées, elle est certainement destinée à jouer un rôle très important dans l'arsenal des sports d'endurance de l'athlète. L'isomaltulose est un disaccharide formé de glucose et de fructose qui est totalement bien digéré et absorbé dans l'intestin, de manière lente et progressive, grâce aux liaisons chimiques très résistantes qui le caractérisent. être un carburant idéal pour un travail d'endurance très prolongé.

Le sportif des sports « d'endurance », grâce à l'isomaltulose, va fournir de l'énergie très rapidement, ACHZOD® Nutrition ne pouvait manquer d'avoir cet élément pour le soutien de l'athlète qui a besoin de performances très prolongées et qui a une demande énergétique importante, et le présente inséré dans ACHZOD® Nutrition Charge ou dans la ligne Legionarivs "Alessio Sakara Special Edition", et surtout c'est un élément très fréquent clairement dans la nouvelle ligne Alphazer® créée spécifiquement pour le monde de l'endurance et des sports extrêmes, avec toute la gamme de gels Alphagel, Alphalyte Energy, Enerfuel et Enerfuel Nitroracing. Avec l'isomaltulose, en effet, les risques de troubles gastro-intestinaux suite à sa prise sont encore réduits et diverses études scientifiques ont montré qu'il est capable de fournir de l'énergie plus longtemps sans risquer de subir ce que l'on appelle des « chutes » glycémiques. Par conséquent, une fois ingéré par l'athlète, il est progressivement absorbé et suit les mêmes processus métaboliques que le saccharose, les sucres libérés par son hydrolyse étant les mêmes que ceux résultant de l'hydrolyse du saccharose. (glucose et fructose).Le processus de digestion est particulièrement "facile" pour le tractus gastro-intestinal, ce qui entraîne une tolérance sensiblement très bonne sans présenter de problèmes gastro-intestinaux particuliers typiques d'autres formes de glucides utilisés dans le sport (par exemple gonflement, fermentation, voire crampes, nausées, diarrhée) ni de réactions allergiques. Une caractéristique digne d'être présentée en sa faveur par rapport aux « parents » plus nobles et particulièrement appréciée également par l'industrie alimentaire, est que, bien qu'il apporte un apport énergétique de 4 Kcal/g, contrairement au saccharose, il ne favorise pas l'apparition des caries car il ne peut pas être utilisé par les micro-organismes responsables de son apparition. glucides et plus d'acides gras, économisant ainsi les glucides.

## Récupération et recharge

Amidon de patte, plus et rire (Karbolyn®) Un autre glucide intéressant de nouvelle génération est le Karbolyn®, qui dérive de diverses sources de matières premières fournies par les pommes de terre, le maïs et le riz qui ont subi une méthode de transformation brevetée, "Enzymatic Milling Process", un processus enzymatique obtenu qui atteint un poids moléculaire élevé avec une excellente solubilité. il s'agissait d'un sucre simple, sans toutefois créer de pic ultérieur ni de chute brutale de la glycémie, Dans la gamme de suppléments ACHZOD® Nutrition, Karbolyn® a été inclus dans Alphatech Recharge, en tant que composant glucidique à combiner avec la protéine hydrolysée de saumon Alphatech. Parmi les différentes sources de glucides que la gamme Alphazer® présente dans son catalogue, il y a aussi le Glucidex® comme Alphalyte Energy. Si les maltodextrines d'ancienne génération peuvent être définies comme dépassées, il existe une évolution technique de celles-ci, sous la forme du "Glucidex®", qui représente la nouvelle génération de maltodextrines hautement purifiées et hautement solubles produites à partir de maïs cireux, de pomme de terre ou de blé, caractérisées par une digestibilité et une bien meilleure tolérance que les maltodextrines précédentes. Ces maltodextrines doivent leurs particularités au fait qu'il s'agit de polymères issus du processus d'hydrolyse de ces amidons fabriqués à travers des procédés de transformation modernes, très bien solubles dans l'eau, facilement assimilables et, grâce à une pression osmotique beaucoup plus faible que les simples glucides moléculaires de faible poids (comme le glucose), ont une vidange gastrique plus rapide mais avec une plus grande vitesse d'absorption et une libération d'énergie progressive, sans déséquilibres glycémiques particuliers, ce qui en fait un autre glucide de choix important pour ceux qui pratiquent des sports d'endurance. 1.Siddiqua, IR ; Furhala, B.1967.Isolation and caractérisation of oligosaccharides from honey.Part I Disaccharides.J Apicult Res 6:139-145.Cité dans : Irwin & Sträter 2.Food Standard Agency UK.Dossier pour la demande d'approbation de l'isomaltulose selon le règlement Novel Food EEC.Disponible sur www.food.gov.uk Règlement (CE) n° 258/97 du Parlement européen et du Conseil du 27 janvier 1997 concernant les nouveaux aliments et les nouveaux ingrédients alimentaires.

Isomaltulose, tréhalose et soja-isoflavones. Rapport sur l'isomaltulose. Rapport NutriScience 72.01.0010/B.5. Achten, J. ; Jentjens, R. ; Jeukendrup, A.2003.Exogenous Oxidation of Saccharose and Isomaltulose Ingested Pendant Moderate Intensity Exercise.Internal Report Cerestar.18 July 2003.6.Gazzetta Ufficiale dell'Unione Europea del 23.06.05.DECISIONE DELLA COMMISSIONE del 4 avril 2005 che authorizza l'immissione in commercio l'isomaltulosio est un nouvel aliment ou un nouvel ingrédient alimentaire dans le cadre du règlement (CE) n° 258/97 du Parlement européen et du Conseil [notifié avec le numéro C(2005) 1001] 7.

Kawai, K. ; Okuda, Y. ; Yamashita, K.1985. Modifications de la glycémie et de l'insuline après une administration orale de palatinose (isomaltulose) chez des sujets normaux. Endocrinol Jpn 32(6):933-936.8.Kawai, K. ; Okuda, Y. ; Chiba, Y. ; Yamashita, K.1986.Palatinose (isomaltulose) en tant que nutriment parentéral potentiel : ses effets métaboliques et son devenir après administration orale et intraveineuse à des chiens.J Nutr Sci Vitaminol 32 :297-306.9.Kawai, K. ; Yoshikawa, H. ; Murayama, Y. ; Okuda, Y. ; Yamashita, K.1989. Utilité du palatinose (isomaltulose) comme édulcorant calorique pour les patients diabétiques.

Horm Metab Res 21 : 338-340. 10.Hespel, P. ; Van den Eede, E. ; Ramaekers, M. ; Muls, E. ; Vansant, G. 2003.Effets de la consommation d'isomaltulose sur la glycémie et la concentration d'insuline au repos et pendant l'exercice chez les patients présentant une résistance à l'insuline : comparaison avec le fructose.Rapport final.10 juillet 2003 11.Liao, Z.-H. ; Li, Y.-B. ; Yao, B. ; Fan, HD-D.; Hu, G.-L. ; Weng, J.-P.2001.Les effets de l'isomaltulose sur la glycémie et les lipides chez les sujets diabétiques.Diabetes 50(Suppl.2) :A366 [Résumé n°1530-P]. 20.Topitsoglou, V. ; Sasaki, N. ; Takazoe, I. ; Frostell, G.1984.Effet de rinçages fréquents avec une solution d'isomaltulose (Palatinose®) sur la production d'acide dans la plaque dentaire humaine.Caries Res 18(1):47-51.Cité dans : Birkhed et al., 1987 21.U.S.FDA.1997.Additifs alimentaires directs secondaires autorisés dans les aliments destinés à la consommation humaine ; Règle proposée (21 CFR Part 173.25). Fed Regist (US) 62(74).
...
---`,
    ...
    readTime: "6 min",
    category: "nutrition",
    image: `https://images.unsplash.com/photo-1551218808767-40a48e3bb5e4?w=800&auto=format&fit=crop`
  },
  {
    id: `yam-9`,
    slug: `yam-carbohydrates-why-how-many-nd-which-ones-to-take-`,
    title: `Glucides : pourquoi, combien et lesquels prendre pour un sportif d'endurance`,
    excerpt: `Les glucides, également appelés sucres, glucides, saccharides ou hydrates chimiques de carbone, font partie des molécules organiques les plus abondantes dans la nature et notre corps les utilise comme principale source d'énergie. Découvrons...`,
    content: `# Glucides : pourquoi, combien et lesquels prendre pour un sportif d'endurance
...
Sports Med. Août 1997; Aragon AA, Schoenfeld BJ.Le timing des nutriments revisité : existe-t-il une fenêtre anabolisante post-exercice ? J Int Soc Sports Nutr. 29 janvier 2013;10(1):5.doi : 10.1186/1550-2783-10-5.PMID : 23360586 ; PMCID : PMC3577439. Robergs RA, Pearson DR, Costill DL, Fink WJ, Pascoe DD, Benedict MA, Lambert CP, Zachweija JJ.

Glycogénolyse musculaire au cours de différentes intensités d'exercices de résistance au poids. J Appl Physiol (1985).1991 avril;70(4):1700-6.doi : 10.1152/jappl.1991.70.4.1700.PMID : 2055849. Takii H, Ishihara K, Kometani T, Okada S, Fushiki T. Amélioration de l'endurance à la nage chez la souris par dextrine cyclique hautement ramifiée.

Biosci Biotechnol Biochem.1999 Dec; Furuyashiki T, Tanimoto H, Yokoyama Y, Kitaura Y, Kuriki T, Shimomura Y.Effets de l'ingestion de dextrine cyclique hautement ramifiée pendant un exercice d'endurance sur l'évaluation de l'effort perçu et des composants sanguins associés au métabolisme énergétique.Biosci Biotechnol Biochem.2014;78(12):2117-9.doi : 10.1080/09168451.2014.943654.Epub 31 juillet 2014.PMID : 25080121. Kayaci F, Ertas Y, Uyar T. Stabilité thermique améliorée de l'eugénol par un complexe d'inclusion de cyclodextrine encapsulé dans des nanofibres polymères électrofilées. J Agric Food Chem.2013 28 août; 23898890.

Burke, Deakin (2010). Nutrition sportive clinique. McGraw-Hill Australia Pty Ltd
...
---`,
  ...
  {
    id: `yam-10`,
    slug: `yam-endurance-nd-proteins--necessary-combination-9`,
    title: `Endurance et protéines, une combinaison nécessaire`,
    excerpt: `Lorsqu'il s'agit de sports d'endurance, on a tendance à se concentrer uniquement sur le rôle et le dosage des glucides : étant des sports d'endurance, les sucres sont le macronutriment essentiel pour assurer une énergie rapide au muscle et au corps....`,
    content: `# Endurance et protéines, une combinaison nécessaire
...
---`,
    ...
    readTime: "6 min",
    category: "nutrition",
    image: `https://images.unsplash.com/photo-1495521939206-a217db9df264?w=800&auto=format&fit=crop`
  },
  {
    id: `yam-11`,
    slug: `yam-dehydration-nd-mineral-salts-role-nd-functions-`,
    title: `Déshydratation et sels minéraux : rôle et fonctions`,
    excerpt: `L'hydratation a toujours joué un rôle important dans la performance sportive, la prévention des blessures et la récupération après des séances d'entraînement ou des compétitions, aussi bien pour les athlètes engagés dans des sports ou compétitions...`,
    content: `# Déshydratation et sels minéraux : rôle et fonctions
...
---`,
  ...
  {
    id: `yam-12`,
    slug: `yam-cycling-nutrition-978`,
    title: `Alimentation cycliste`,
    excerpt: `La capacité à faire des efforts à long terme est déterminée dans une large mesure par la capacité aérobie potentielle élevée, la disponibilité de substrats énergétiques, l'activité enzymatique et l'efficacité de la thermorégulation et du système...`,
    content: `# Alimentation cycliste

## Exigences du cyclisme

La capacité à faire des efforts à long terme est déterminée dans une large mesure par la capacité aérobie potentielle élevée, la disponibilité de substrats énergétiques, l'activité enzymatique et l'efficacité de la thermorégulation et du système cardiorespiratoire. Ces compétences constituent une base fondamentale nécessaire pour évaluer le niveau de forme physique d'un athlète et sont conditionnées par divers facteurs, parmi lesquels il convient de souligner la génétique, le régime d'entraînement, la nutrition et la composition corporelle. En outre, il convient de souligner que l'entraînement intensif, l'inadéquation nutritionnelle et le stress mental entraînent une fatigue et des dommages musculaires, ainsi qu'un stress oxydatif, qui façonnent les besoins nutritionnels spécifiques des personnes physiquement actives. De quoi a besoin un athlète d’endurance ?

Les sports d'endurance sont de plus en plus populaires et les athlètes de tous niveaux recherchent des moyens d'optimiser leurs performances grâce à l'entraînement et à la nutrition. Pour un exercice d'endurance d'une durée de 30 minutes ou plus, les facteurs les plus susceptibles de contribuer à la fatigue sont la déshydratation et l'épuisement du glycogène, tandis que les problèmes gastro-intestinaux, l'hyperthermie et l'hyponatrémie peuvent réduire les performances physiques et sont potentiellement dangereux pour la santé, en particulier lors d'événements plus longs (> 4 h). Bien que des concentrations initiales élevées de glycogène musculaire puissent être bénéfiques pour les exercices d'endurance, cela ne doit pas nécessairement être obtenu par le protocole de surcompensation traditionnel. Une stratégie nutritionnelle personnalisée peut être développée qui vise à fournir des glucides au muscle qui travaille à un rythme qui dépend de l'intensité absolue de l'exercice et de la durée de l'événement.

## Avant la sortie

Les athlètes d'endurance doivent s'efforcer de minimiser la déshydratation et de limiter la perte de masse corporelle par transpiration à 2-3 % de la masse corporelle. Les problèmes gastro-intestinaux surviennent fréquemment, en particulier dans les courses de longue distance. Le rôle de la nutrition chez le cycliste Une bonne nutrition est importante à chaque étape de l'entraînement et de la compétition. Le cycliste de compétition sérieux et le cycliste récréatif doivent suivre une alimentation équilibrée qui fournit suffisamment de calories pour répondre à leurs besoins énergétiques.

Les athlètes qui consomment moins de 2 000 calories par jour peuvent avoir du mal à satisfaire leurs besoins en nutriments, en particulier en fer et en calcium. La perte de poids, l'épuisement du glycogène et la déshydratation sont également des résultats possibles d'une alimentation inadéquate. Des stratégies alimentaires visant à améliorer ou à maintenir les réserves de glucides de l'organisme sont nécessaires à la performance, en particulier pour les cyclistes qui effectuent de nombreux kilomètres d'entraînement ou qui participent à des courses sur route et à d'autres épreuves d'endurance. De plus, les cyclistes doivent être encouragés à boire beaucoup de liquides, surtout lorsqu'ils se trouvent dans un environnement chaud.

## Pendant l'effort

Il semble que les besoins en protéines des athlètes d'endurance augmentent avec la durée et l'intensité de l'exercice. Cependant, des facteurs tels que l'apport calorique total et la qualité des protéines doivent être pris en compte lors de la détermination de vos besoins en protéines. De nombreux athlètes sont préoccupés par leur apport en vitamines et en minéraux et utilisent souvent des suppléments nutritionnels à la fois pour des raisons « d'assurance maladie » et de performance. Les suppléments les plus couramment pris sont la vitamine C, le complexe B et le fer.

Les vitamines et les minéraux en excès par rapport aux AJR n'améliorent pas les performances et peuvent être toxiques lorsqu'ils sont consommés en grande quantité. D'un autre côté, il faut considérer que les végétariens et les cyclistes ayant un faible apport calorique peuvent bénéficier d'un supplément multivitaminé ou minéral. Quelle est l'importance de la composition corporelle pour un cycliste En outre, un autre aspect important du point de vue de l'entraînement sportif d'endurance est l'obtention et le maintien d'un état nutritionnel adéquat. À cet égard, le facteur clé fournissant des informations sur l'état nutritionnel est la composition corporelle, ainsi que l'analyse de la concentration de certains marqueurs biochimiques cliniquement pertinents (par exemple dans le sang, la salive, l'urine).

## Récupération

Le suivi des indicateurs de composition corporelle des athlètes permet, entre autres, d'évaluer l'efficacité des interventions diététiques et d'entraînement. D'autre part, la manipulation de la composition corporelle permet de soutenir la performance physique, l'adaptation aux exigences d'une discipline sportive donnée et la prise en charge de charges d'exercices de haute intensité. De même, un élément important est également l'évaluation de l'état nutritionnel qui implique l'analyse de l'équilibre des nutriments sélectionnés, en particulier sur une perspective et une durée plus longues. Une étude récente, publiée en décembre 2022, a analysé le comportement d'un large groupe de sportifs d'endurance (une cinquantaine) en évaluant leurs conditions nutritionnelles (analyse des nutriments apportés avec l'alimentation de la période considérée et composition corporelle).

Voici les résultats : L'évaluation de la valeur nutritionnelle de l'alimentation indique que les athlètes étudiés n'ont pas périodisé leur alimentation en fonction du cycle d'entraînement (période d'entraînement vs compétition). Pendant la période de compétition, les athlètes ont effectué le test d'effort progressif significativement plus longtemps (p = 0,025) que pendant la période d'entraînement. De plus, le % VO 2max_VT a diminué (p = 0,047) pendant la période de compétition. Cependant, l'absence de changements dans l'absorption relative du VO 2 par rapport au VT peut limiter la signification clinique des changements du % VO 2max_VT ci-dessus.

Bien qu'il n'y ait pas eu de différences dans l'apport alimentaire en minéraux et en vitamines dans le groupe d'étude entre les périodes d'entraînement et de compétition dans cette étude, il y avait plusieurs carences. Dans les deux périodes d'entraînement, la valeur énergétique du régime alimentaire des athlètes étudiés, ainsi que l'apport en glucides et en acide folique, étaient inférieurs aux recommandations. De plus, l'apport en vitamine C pendant la période d'entraînement et l'apport en calcium pendant la période de compétition étaient insuffisants. ainsi que des carences en vitamines D et E. Dans l'approche holistique et interdisciplinaire de l'entraînement sportif, la composition corporelle reflète avant tout l'état nutritionnel des athlètes.

Le suivi de la composition corporelle permet donc d'évaluer l'efficacité des interventions nutritionnelles et d'entraînement entreprises. La manipulation délibérée de la composition corporelle lors de différentes périodes de macrocycles d'entraînement permet, entre autres, de soutenir la performance physique, de répondre aux exigences physiques d'un sport donné et de faire face à des charges d'exercices importantes. Les athlètes d'endurance d'élite sont généralement minces et ont une masse corporelle relativement faible en raison des facteurs génétiques qui les prédisposaient à réussir. dans leur sport, ainsi que les effets modificateurs de Brunkhorst L., Kielstein H. Comparaison des caractéristiques anthropométriques entre triathlètes professionnels et cyclistes.Biol.Sport.2013;30 : 269-27 Maughan R.J., Burke L.M., Dvorak J., Larson-Meyer D.E., Peeling P., Phillips S.M., Engebretsen L.Déclaration de consensus du CIO : Les compléments alimentaires et l'athlète de haute performance.Br.J.Sports Med.2018 ;52 : 439-455.

Les triathlètes périodisent-ils leur alimentation et leur teneur en minéraux, leur composition corporelle et leur capacité aérobie changent-ils pendant les périodes d'entraînement et de compétition ? Krzysztof Durkalec-Michalski, Natalia Glowka, Paulina M Nowaczyk, Anna Laszczak, Anna Gogojewicz, Joanna Suliburska ; Nutriments.20 décembre 2022;15(1):6. Jeukendrup A, Nutrition pour les sports d'endurance : marathon, triathlon et cyclisme sur route. J Sports Sci.2011 ; 29 Suppl 1 : S91-9.
...
---`,
  ...
  {
    id: `yam-13`,
    slug: `yam-athlete-nutrition-focus-on-the-tennis-player-945`,
    title: `Nutrition du sportif : focus sur le joueur de tennis`,
    excerpt: `Le tennis est un sport très apprécié et répandu, qui demande une énorme quantité d'énergie, tant physique que mentale. Sa pratique implique un dévouement constant et durable, et amène les athlètes à passer la plupart de leur temps directement dans...`,
    content: `# Nutrition du sportif : focus sur le joueur de tennis

## Exigences physiques du tennis

Le tennis est un sport très apprécié et répandu, qui demande une énorme quantité d'énergie, tant physique que mentale. Sa pratique implique un dévouement constant et durable, et amène les athlètes à passer la plupart de leur temps directement dans leur habitat : le terrain. Discipline, rythmes de vol et saine compétition sont les piliers de ce sport. Voyons ensemble comment un joueur de tennis peut gérer sa nutrition et son intégration pour mieux affronter chaque match.

Sport intermittent, entre métabolisme aérobie et anaérobie Le tennis est techniquement défini comme une discipline intermittente : un sport de haute intensité, caractérisé par des mouvements à des vitesses différentes alternés avec de courtes pauses. Du point de vue métabolique, des engagements différents et alternés sont donc requis de l'organisme. En effet, les métabolismes aérobie, anaérobie lactique et anaérobie alactacide sont utilisés. Cela se  des besoins alimentaires spécifiques et importants, afin de soutenir le corps aussi bien lors des secousses et des mouvements rapides que lors de performances très prolongées. être de haute intensité et créer une tension musculaire, tandis que le coup de balle nécessite un engagement d'intensité moyenne, qui peut devenir intense, également en fonction de la durée du match.

Il n'est en effet pas possible de savoir à l'avance combien de temps durera le match : le plus long de l'histoire du tennis a eu lieu actuellement à Wimbledon 2010, lors du match entre John Isner et Nicolas Mahut, qui a duré 11 heures et 5 minutes. Il est donc évident qu'une alimentation correcte peut être d'une grande influence pour garantir l'énergie nécessaire pour soutenir un tel effort. Consommation calorique et besoins du joueur de tennis Il est bon de rappeler que chaque athlète a des besoins nutritionnels spécifiques et son propre métabolisme de base, qui dépendent de l'âge, du sexe, de la masse musculaire ainsi que de la durée et de l'intensité de l'entraînement. Cependant, nous pouvons identifier ces paramètres généraux pour établir la consommation calorique : La dépense énergétique est donc très élevée, et l'alimentation adoptée doit être équilibrée et en relation avec la consommation calorique requise par l'entraînement.

Même l'environnement environnant, entendu comme les conditions de température et d'humidité, influence grandement la demande énergétique, à travers des mécanismes autonomes et/ou comportementaux. Cependant, l'activité intermittente de ce sport signifie que les joueurs, dans la plupart des environnements (<35°C), sont capables de réguler leur température corporelle dans des limites sûres. Il faut partir d'un postulat : il n'existe pas de régime exclusif valable pour tous les joueurs de tennis. Au lieu de cela, il est correct de penser en établissant toujours une alimentation variée et équilibrée, qui apporte tous les macronutriments dans les bonnes proportions.

## Besoins énergétiques

En général, c'est une bonne idée de s'orienter vers la consommation de 5 repas par jour (divisés en petit-déjeuner, collation, déjeuner, collation et dîner), en divisant les macronutriments dans le « style méditerranéen » : 50-55% des kcal devraient proviennent de glucides, 15 à 20 % de protéines et 30 à 35 % de graisses. Cela permet une bonne digestion et des réserves d'énergie suffisantes pour les activités du joueur de tennis. La gestion des glucides joue un rôle clé dans la performance au tennis. Il est connu dans le sport qu'une alimentation riche en glucides permet d'augmenter les réserves de glycogène musculaire, et que cela est étroitement lié à une performance optimale dans les activités d'endurance.

Un régime pauvre en glucides est à éviter : il peut compromettre les exercices de haute intensité et même l'endurance. Lors des matchs de haute intensité, l'oxydation des glucides contribue de manière significative à la production d'ATP. En règle générale, les joueurs de tennis d'élite devraient donc avoir une alimentation généralement riche en CHO, entre 6 et 10 g/kg de poids/jour (les femmes ont généralement besoin d'une quantité légèrement inférieure à celle des hommes). Par sport de raquette, les données sur les besoins alimentaires en protéines sont limitées et la plupart des lignes directrices se réfèrent exclusivement aux athlètes de force ou d'endurance.

Cependant, le tennis inclut à la fois des aspects de force et d'endurance, et il est donc plus approprié d'estimer les besoins de ces athlètes en fonction du volume et de l'intensité de l'entraînement ou de la compétition. musculaire, les besoins quotidiens peuvent varier comme suit : En raison de l'absence d'une véritable « intersaison » pour la nature du tennis professionnel, les athlètes doivent maintenir une composition corporelle optimale tout au long de l'année. En plus des glucides, l'oxydation des graisses contribue également à fournir de l'énergie, surtout lorsque le match dure longtemps. Les directives indiquent que les quantités recommandées pour assurer des réserves intramusculaires adéquates de triglycérides pour un joueur de tennis sont d'environ 2 g/kg poids/jour. L'eau est indispensable dans l'alimentation de chacun.

On ne peut pas renoncer à une bonne hydratation, qui doit être calibrée en fonction des besoins liés à la fatigue, à l'environnement dans lequel on s'entraîne et à la transpiration qui en découle. Les joueurs de tennis doivent boire beaucoup de liquides, et les apports peuvent varier de 400 à 1000 ml/heure en fonction de la tolérance individuelle et des conditions atmosphériques. Il est important de boire souvent, pour s'assurer que ces volumes importants sont mieux tolérés. D'eau à intervalles de 15-20 minutes est optimale compte tenu du temps de vidange gastrique.

## Hydratation et nutrition

Surtout pour les agonistes, l'eau peut ne pas suffire : en cas de transpiration intense, des quantités importantes de sels minéraux sont également perdues, et il est conseillé de veiller à la consommation correcte de boissons (ou boissons pour sportifs) contenant du sodium pour éviter le risque d'hyponatrémie. En général, les besoins du joueur de tennis ne sont pas différents de ceux des autres athlètes d'endurance. Les vitamines, utiles pour lutter contre les radicaux libres qui peuvent se former lorsque la demande énergétique est très élevée, et les minéraux, essentiels pour rétablir l'équilibre hydro-salin après une transpiration intense, sont d'une importance capitale. La réparation musculaire est également très importante, et à cet effet, l'intégration d'acides aminés à chaîne ramifiée (BCAA) est utile.

Voici les suppléments avec le plus de preuves scientifiques : Attention à l'après-match : l'importance de la récupération La gestion de l'après-entraînement ou de l'après-compétition est également très importante : dans cette phase, il faut veiller à ce que l'organisme soit approvisionné avec tout ce dont il a besoin pour une récupération optimale. La nutrition du joueur de tennis et l'intégration d'après-match visent à restaurer les stocks hydrosalins, à réparer les structures protéiques des muscles des dommages causés par l'effort et à favoriser la reconstitution du glycogène musculaire. Cette phase ne doit donc pas du tout être négligée. Mais comment se comporter pour une récupération correcte ?

Qu'il s'agisse d'une rencontre entre joueurs de tennis professionnels ou d'un défi entre amis, dans ce sport, l'aspect nutritionnel ne doit pas être sous-estimé, car il y a un engagement physique important tant du point de vue musculaire que d'endurance. La nutrition et la supplémentation peuvent être utilisées pour augmenter les performances, éviter la perte de forme et minimiser les réactions qui surviennent pendant et après l'effort. Et, citant une citation du champion Rafael Nadal, « Aucune balle n'est la même que celle qui la précède. Aucun coup n'est identique à un autre.

Chaque fois que vous vous préparez à recevoir Il faut donc évaluer, en une fraction de seconde, la trajectoire et la vitesse du ballon et décider comment, combien d'énergie et où tenter de contrer.". Il est donc bon d'être prêt. Dans tous les domaines. Ranchordas MK, Rogersion D, Ruddock A, Killer SC, Winter EM.Nutrition pour le tennis : recommandations pratiques.J Sports Sci Med.2013 1er juin ;12(2):211-24.PMID : 24149799 ; PMCID : PMC3761836.

## Supplémentation

Fleming JA, Naughton RJ, Harper LD. Enquête sur les habitudes nutritionnelles et de récupération des joueurs de tennis. Nutrients. 3 avril 2018; PMCID : PMC5946228. Fleming JA, Catháin CÓ, Harper LD, Naughton RJ.

Apport alimentaire et distribution quotidienne de glucides, de protéines et de graisses chez les jeunes joueurs de tennis sur une période d'entraînement et de compétition de 7 jours. J Sports Sci Med.2021 17 mai; 34267580 ; PMCID : PMC8256522. Truax S, Fleming JA, Cross BL, Grosicki GJ. Habitudes nutritionnelles des joueurs de tennis adolescents avant, pendant et après le match.

Minerva Pediatr (Torino). 21 juin 2022. doi : 10.23736/S2724-5276.22.06878-1. Kovacs MS.Apport en glucides et tennis : y a-t-il des bénéfices ? Br J Sports Med.2006 mai;40(5):e13.doi: 10.1136/bjsm.2005.023291.PMID: 16632561; PMCID : PMC2653877. Gomes RV, Capitani CD, Ugrinowitsch C, Zourdos MC, Fernandez-Fernandez J, Mendez-Villanueva A, Aoki MS.

La supplémentation en glucides améliore-t-elle les performances en match de tennis ? J Int Soc Sports Nutr.2013 22 octobre;10(1):46. est ce que je : 10.1186/1550-2783-10-46.PMID : 24148197 ; PMCID : PMC3874750. Hornery DJ, Farrow D, Mujika I, Young W. Fatigue au tennis : mécanismes de fatigue et effet sur la performance.

Sports Med.2007;37(3):199-212.doi : 10.2165/00007256-200737030-00002.PMID : 17326696.
...
---`,
  ...
  {
    id: `yam-14`,
    slug: `yam-athlete-nutrition-focus-on-the-sprinter-937`,
    title: `Nutrition du sportif : focus sur le sprinter`,
    excerpt: `Nutrition du sportif : focus sur le sprinter L'athlétisme est un sport olympique composé de diverses disciplines, même différentes les unes des autres : courses sur piste, compétitions (lancers, sauts en élévation et sauts en extension), épreuves...`,
    content: `# Nutrition du sportif : focus sur le sprinter
...
---`,
    ...
    readTime: "6 min",
    category: "nutrition",
    image: `https://images.unsplash.com/photo-1470468969717-61d5d54fd036?w=800&auto=format&fit=crop`
  },
  {
    id: `yam-15`,
    slug: `yam-winter-sports-nutrition-nd-supplementation-953`,
    title: `Sports d'hiver : nutrition et supplémentation`,
    excerpt: `Par « sports d'hiver », nous entendons tous les sports qui se pratiquent sur la neige et la glace, traditionnellement pendant la période hivernale dans les pays alpins, en Europe du Nord et de l'Est, au Japon, en Amérique du Nord et du Sud. Ils sont...`,
    content: `# Sports d'hiver : nutrition et supplémentation
...
Nutrition humaine dans les altitudes terrestres froides et élevées. Int J Biometeorol. 1992 mars; Butterfield GE, Gates J, Fleming S, Brooks GA, Sutton JR, Reeves JT. L'augmentation de l'apport énergétique minimise la perte de poids chez les hommes à haute altitude. J Appl Physiol (1985).

Ferguson RA. Limites de performance en ski alpin. Exp Physiol. 2010 mars; Fulco CS, Kambis KW, Friedlander AL, Rock PB, Muza SR, Cymerman A. La supplémentation en glucides améliore les performances du cycle d'essai contre la montre lors d'un déficit énergétique à 4 300 m d'altitude.

J Appl Physiol (1985). 5 mai 2005.PMID : 15879171. Kayser B.Nutrition et exposition à haute altitude.Int J Sports Med.1992 Oct;13 Suppl 1:S129-32.doi : 10.1055/s-2007-1024616.PMID : 1483750. Larsson P, Henriksson-Larsén K. Composition corporelle et performances en ski de fond.

Int J Sports Med.2008 Dec; Seifert JG, Luetkemeier MJ, White AT, Mino LM.Les effets physiologiques de l'ingestion de boissons pendant l'entraînement de ski de fond chez les skieurs collégiaux d'élite.Can J Appl Physiol.1998 février;23(1):66-73.doi: 10.1139/h98-004.PMID: 9494740. Szmedra L, Im J, Nioka S, Chance B, Rundell KW. Désaturation en oxygène de l'hémoglobine/myoglobine pendant le ski alpin. Med Sci Sports Exerc.2001 Feb; Tesch P, Larsson L, Eriksson A, Karlsson J.

Épuisement musculaire en glycogène et concentration de lactate pendant le ski alpin. Med Sci Sports. Été 1978; 10 (2): 85-90. PMID: 692307.
...
---`,
  ...
  {
    id: `yam-16`,
    slug: `yam-energy-bars-in-endurance-sports-928`,
    title: `Les barres énergétiques dans les sports d'endurance`,
    excerpt: `Les sports d'endurance représentent un grand défi tant pour l'athlète que pour notre corps, ce sont en effet des activités qui demandent de longs efforts, avec une fatigue musculaire prolongée, et il est donc très important de savoir doser la force,...`,
    content: `# Les barres énergétiques dans les sports d'endurance
...
---`,
    ...
    readTime: "6 min",
    category: "nutrition",
    image: `https://images.unsplash.com/photo-1528498033373-3c6c08e93d79?w=800&auto=format&fit=crop`
  },
  {
    id: `yam-17`,
    slug: `yam-is-there--best-training-for-hypertrophy-volume-vs`,
    title: `Existe-t-il un « meilleur entraînement pour l’hypertrophie » ? Volume vs intensité`,
    excerpt: `L'entraînement en surcharge, utilisé dans de nombreuses disciplines comme le bodybuilding, le cross training et le powerlifting, est certainement l'un des moyens les plus efficaces pour stimuler l'hypertrophie musculaire et améliorer la force. By...`,
    content: `# Existe-t-il un « meilleur entraînement pour l’hypertrophie » ? Volume vs intensité

## Le débat volume vs intensité

L'entraînement en surcharge, utilisé dans de nombreuses disciplines comme le bodybuilding, le cross training et le powerlifting, est certainement l'un des moyens les plus efficaces pour stimuler l'hypertrophie musculaire et améliorer la force. By correctly manipulating the training variables, including: We can change the type and intensity of stimulus we provide to the musculoskeletal system by combining mechanical and metabolic stresses. Often it tends to identify the best training in terms of volume of work done or intensity (often compared to the high percentage of load used), trying to identify a method of work "better than the other. From the point of view of scientific research we know that as the intensity of the exercise increases with the use of overloads (resulting in an increase in the activation of muscle fibres with rapid contraction), greater emphasis is placed on mechanical stress (1).

On the contrary, high-volume programmes, with a relative reduction in workload - oriented to a greater number of repetitions concomitant with the use of short rest intervals -, physiologically create greater metabolic stress (2). What is essential to trigger the mechanism of hypertrophy is a minimum intensity, often identified with a load greater than 50% of 1 MRI, intensity precisely necessary to trigger the mechanism of muscle hypertrophy. The increasing scientific research on overload training, given its undoubted health benefits to individuals, has also led to large international organizations, such as the American College of Sports Medicine, to create guidelines trying to identify the best strategies and combinations between load and volume, to achieve the most efficient results at the hypertrophic level. A repetition range between (6-12 RM) has been considered among the most effective for hypertrophy training, representing a sufficient balance of mechanical and metabolic stress to the trainee (2).

## Mécanismes de l'hypertrophie

Other schools of thought and lines of research indicate that inducing greater mechanical stress, increasing the load and its intensity, can induce recruitment of muscle fibres with higher rapid contraction and provide a greater stimulus for muscle hypertrophy - compared to metabolic stress associated with high volume training (3) -. Studies comparing high-intensity training programs to high volume oriented ones, in people with experience in overload training, are actually few at the moment. This makes it difficult to identify the best strategy. From most of these studies, it emerged that high-intensity training is certainly more advantageous for strength improvement, but almost similar to high volume training protocols to improve muscle hypertrophy (4.5) By making a more in-depth analysis, we can safely say that there is a clear relationship between the volume of training carried out and muscle hypertrophy (6, 7) while to a lesser extent on the increase in strength (8, 9)we also know that increasing the volume of work alone, especially not taking into account the age of experience of the athlete, can be counterproductive (10).

If we consider simplistically the amount of work done with increased hypertrophy and strength, we could erroneously conclude that making as much volume as possible in each training session, would be the optimal way to achieve maximum hypertrophy. However, it is often forgotten that a workout is useful when you have the ability and time to recover from this, thus creating an adaptation, represented by the quantitative and qualitative increase in muscle mass, as demonstrated by the study above. A huge volume of work that you are not used to in a single session can negatively affect performance up to 72 hours. To this must be added the concept of periodization of training that, it has been seen - through the organization in micro and mesocycles and its progressive increase in load -, be more effective to achieve an improvement in performance (11).
...
Schoenfeld, B.J., D.Ogborn et J.W.Krieger, Relation dose-réponse entre le volume hebdomadaire d'entraînement en résistance et l'augmentation de la masse musculaire : revue systématique et méta-analyse. J Sports Sci, 2017.35(11) : p.1073-1082. 8.Krieger, J.W., Séries simples ou multiples d'exercices de résistance : une méta-régression. J Strength Cond Res, 2009.23(6) : p.1890-901. 9. Robbins, D.W., P.W.Marshall et M.McEwen, L'effet du volume d'entraînement sur la force du bas du corps.

J Strength Cond Res, 2012.26(1) : p.34-9. 10. Gonzalez-Badillo, J.J., et al., Un volume d'entraînement en résistance modéré produit des gains de force plus favorables que des volumes élevés ou faibles au cours d'un cycle d'entraînement à court terme. J Strength Cond Res, 2005.19(3) : p.689-97. 11.Zourdos, M.C., et al., Le modèle de périodisation ondulante quotidienne modifiée produit de meilleures performances qu'une configuration traditionnelle chez les dynamophiles.J Strength Cond Res, 2016.30(3) : p.784-91. 12. Schoenfeld, B.J., et al., Effets de différentes stratégies de chargement d'entraînement en résistance assimilées au volume sur les adaptations musculaires chez les hommes bien entraînés.

Journal of Strength and Conditioning Research, 2014.29(10) : p.2909-18. 13.Schoenfeld, B., Les lésions musculaires induites par l'exercice jouent-elles un rôle dans l'hypertrophie des muscles squelettiques ? J Strength Cond Res, 2012.26(5) : p.1441-53. 14.Wernbom, M., J.Augustsson et R.Thomee, L'influence de la fréquence, de l'intensité, du volume et du mode d'entraînement en force sur la zone transversale musculaire entière chez l'homme. Sports Med, 2007.37(3) : p.225-64.
...
---`,
  ...
  {
    id: `yam-18`,
    slug: `yam-sst-method-sarcoplasmic-stimulation-training-669`,
    title: `Méthode SST : entraînement à la stimulation sarcoplasmique`,
    excerpt: `Il est crucial de connaître et de comprendre quels processus physiologiques et biochimiques doivent avoir lieu afin de maximiser un stimulus d'entraînement optimal. Des concepts tels que l'augmentation progressive de la tension mécanique, les...`,
    content: `# Méthode SST : entraînement à la stimulation sarcoplasmique
...
---`,
  ...
  {
    id: `yam-19`,
    slug: `yam-shoulder-training-the-5-best-exercises-for-deltoid`,
    title: `Entraînement des épaules | Les 5 meilleurs exercices pour les deltoïdes`,
    excerpt: `Le deltoïde est le muscle principal de l'épaule et est anatomiquement divisé en trois groupes de fibres ou « têtes » : le deltoïde antérieur, le deltoïde médial ou latéral et le deltoïde postérieur. Les trois têtes convergent dans l’humérus, mais...`,
    content: `# Entraînement des épaules | Les 5 meilleurs exercices pour les deltoïdes
...
---`,
  ...
  {
    id: `yam-20`,
    slug: `yam-pump-vs-cell-volumization-in-bodybuilding-30`,
    title: `Pompe vs Volumisation Cellulaire en musculation`,
    excerpt: `La phrase d'Arnold où il compare les pompes musculaires pendant l'entraînement à un orgasme est inoubliable. Tous ceux qui font de la musculation sont obsessionnellement liés à cette sensation agréable, qui frise souvent ou devient tout simplement...`,
    content: `# Pompe vs Volumisation Cellulaire en musculation
...
---`,
  ...
  {
    id: `yam-21`,
    slug: `hypertrophie-musculaire-volume-vs-intensite`,
    title: `Hypertrophie musculaire : volume vs intensité`,
    excerpt: `L'évaluation de la composition corporelle est désormais une pratique courante dans l'histoire du sport, car les évaluations de la masse corporelle totale (BM) sont des paramètres fondamentaux dans certaines disciplines, par exemple où il existe une...`,
    content: `# Hypertrophie musculaire : volume vs intensité
...
---`,
  ...
  {
    id: `yam-22`,
    slug: `yam-cross-training-what-is-it-false-myths-truth-811`,
    title: `Formation croisée | Qu'est-ce que c'est, de faux mythes, la vérité`,
    excerpt: `Ces dernières années, le cross Training est une discipline sportive très populaire. On en parle beaucoup et nombreux sont ceux qui disent qu'il s'agit d'une tendance passagère, sans toutefois savoir en quoi elle consiste réellement. La définition «...`,
    content: `# Formation croisée | Qu'est-ce que c'est, de faux mythes, la vérité
...
---`,
  ...
  {
    id: `yam-23`,
    slug: `yam-triathlon-how-to-train-practical-tips-to-get-start`,
    title: `Triathlon | Comment s'entraîner ? Conseils pratiques pour commencer`,
    excerpt: `Le triathlon, le sport du « surhomme », est dans l'imaginaire commun, à tel point que la compétition la plus connue et la plus longue au monde s'appelle Ironman . Dans cette course, des femmes et des hommes, vêtus exclusivement d'un body sans...`,
    content: `# Triathlon | Comment s'entraîner ? Conseils pratiques pour commencer

## Distances et formats

Le triathlon, le sport du « surhomme », est dans l'imaginaire commun, à tel point que la compétition la plus connue et la plus longue au monde s'appelle Ironman . Dans cette course, des femmes et des hommes, vêtus exclusivement d'un body sans manches si moulant qu'il ressemble à une seconde peau, affrontent sans relâche une partie de nage en eau libre, une partie de cyclisme sur route et une dernière partie de course à pied. L'entraînement du triathlon doit être abordé de manière très différente selon l'objectif de la compétition. Il existe en effet des compétitions sur des distances et des règles à respecter très différentes.

La combinaison de ces deux facteurs modifie de manière assez significative la structure de la préparation. La règle qui a le plus d'impact sur l'entraînement d'un triathlon est sans doute la possibilité ou non de réaliser des actions de groupe, et de rester dans le sillage d'un/des autres concurrents lors de la partie cycliste. Nous n'entrerons pas dans les détails dans cet article, mais cette règle change drastiquement les tactiques de compétition et les principales caractéristiques sportives à entraîner lors de la préparation. Au niveau national et international, les distances les plus courantes et reconnues du triathlon sur route (il existe également le triathlon tout-terrain ou le cross-triathlon) sont : Formation Traithlon : par où commencer ?

## Par où commencer

Sans aucun doute, pour affronter le triathlon, il faut savoir : nager, pédaler et courir ! Si vous ne l'avez jamais fait ou si vous l'avez fait sans trop d'efforts, vous aurez besoin (au moins dans un premier temps) du soutien de professionnels compétents et d'un peu de temps pour apprendre la bonne technique des trois disciplines, indispensable pour prévenir les blessures et améliorer vos performances. Une fois que vous maîtrisez la technique, vous devez vous entraîner séparément à nager, pédaler et courir pour adapter votre physique et le rendre capable de parcourir, au moins séparément, les distances de course prévues. Ce n'est pas fini : il faut être capable de nager, pédaler et courir, le même jour, consécutivement, sans interruption, en gérant également au mieux les phases de transition entre les trois fractions (T1 entre natation et vélo, T2 entre vélo et course à pied).

Programmer un programme d'entraînement multisports, comme dans le cas du triathlète, n'est en aucun cas un travail anodin. En particulier, pour l'amateur qui doit concilier l'entraînement avec le peu de temps libre disponible et le stress dérivant de la vie quotidienne, et qui doit nécessairement être pris en compte et ajouté au stress dérivant de charges d'entraînement spécifiques dans la programmation. Une autre raison d'encourager le soutien des professionnels du secteur, au moins dans la phase initiale. Triathlon : Conseils utiles pour aborder l’entraînement  je souhaite vous donner cinq conseils de base pour aborder l'entraînement au triathlon.

## Conseils pratiques

Même si vous n'avez jamais nagé, fait du vélo ou couru, si vous n'êtes pas un sportif doté d'une force et d'une endurance extraordinaires, si vous travaillez neuf ou dix heures par jour, si vous avez une famille, une maison à courir, des courses, etc., ces conseils peuvent vous aider à affronter une course avec la bonne attitude et la bonne préparation. Fixez-vous des objectifs progressifs et graduels, sans en faire trop Commencez par les triathlons sprint, qui se déroulent sur des distances accessibles à toute personne ayant un entraînement bien structuré. Prenez le temps d'apprendre la bonne technique des trois disciplines et adaptez-vous progressivement à l'entraînement et à l'effort, en devenant de plus en plus résistant et en voyant l'objectif des distances plus longues se rapprocher et se rendre progressivement plus accessible. Consacrer beaucoup de temps aux techniques de natation, de course et de pédalage Si vous en avez l'occasion, faites-le avec l'accompagnement de moniteurs ou de professionnels compétents.

Ce n'est pas du temps retiré à la formation, c'est la base de la formation ! En améliorant votre technique, vous réduisez de façon exponentielle les risques de blessures et augmentez l'efficacité, pouvant ainsi parcourir une plus grande distance, travailler moins et parvenir ensuite à augmenter votre vitesse de croisière pour la même distance. Respectez votre corps et apprenez à écouter les messages qu'il veut vous envoyer Les sources de stress s'additionnent, quelle que soit leur origine. N'essayez pas d'en faire trop, de réaliser à tout prix un entraînement de haute intensité, à des moments impensables et dans des endroits dangereux.

## Planification

Pour un athlète inégal et inexpérimenté, il vaut mieux un entraînement sauté ou un entraînement de très faible intensité lors d'une journée difficile (qui agit comme une régénération et un anti-stress), plutôt qu'une charge de stress excessive qui peut entraîner de la fatigue, l'obligeant à sauter ou à effectuer les séances prévues pour les jours suivants de manière non optimale. Au niveau amateur, il est beaucoup plus facile de se retrouver confronté à un surentraînement ou à une blessure qui pourrait vous obliger à réduire vos effectifs ou, pire encore, à abandonner vos objectifs, plutôt que de subir un désentraînement. Entraînez-vous en pensant d’abord à votre tranquillité d’esprit et à votre bien-être Sans entrer dans des mécanismes psychologiques tordus et frustrants qui vous poussent à démontrer constamment, à chaque entraînement, à vous-même et aux autres que vous pouvez aller plus loin. Respectez votre emploi du temps avec constance, patience et confiance en sa valeur (et faites confiance à la valeur de l'entraîneur derrière le programme !).

Votre objectif est la course : ce sera le jour où vous résumerez et démontrerez tout ce que vous avez construit avec engagement, patience, persévérance, sacrifice et dévouement. 3/4 d'entraînements bien structurés et planifiés d'un maximum de 90' par semaine suffisent, réalisés de manière cohérente pendant quelques mois D'une manière générale, vous pouvez alterner les entraînements de natation, de vélo et de course à pied. Si vous le pouvez, peut-être le week-end, incluez un entraînement combiné vélo-course à pied ou un entraînement de renforcement aérobique à vélo plus long que d'habitude (n'en faites pas trop !) suivi d'un entraînement de course à pied le lendemain. L'entraînement « combiné » des trois disciplines constitue la compétition, où la logistique est facilitée et la motivation est très élevée. Que pensez-vous de ces conseils d'entraînement pour affronter un triathlon ?
...
---`,
  ...
  {
    id: `yam-24`,
    slug: `yam-open-water-swimming-between-training-nutrition-nd`,
    title: `Nage en eau libre entre entraînement, nutrition et supplémentation`,
    excerpt: `La nage de fond comprend toutes les épreuves de natation qui se déroulent en eaux libres telles que les rivières, les lacs et les mers (pour cette raison, on l'appelle également nage en eau libre). Elle est divisée en quatre catégories : natation...`,
    content: `# Nage en eau libre entre entraînement, nutrition et supplémentation
...
---`,
  ...
  {
    id: `yam-25`,
    slug: `yam-padel-between-fashion-training-nd-nutrition-946`,
    title: `Padel : entre mode, entraînement et nutrition`,
    excerpt: `Padel : entre mode, entraînement et nutrition Le padel est un sport qui se joue à deux, très similaire au tennis (dont il dérive) et particulièrement apprécié pour ses règles simples et pour sa capacité à créer une agrégation entre personnes de...`,
    content: `# Padel : entre mode, entraînement et nutrition

## Le padel en plein essor

Padel : entre mode, entraînement et nutrition Le padel est un sport qui se joue à deux, très similaire au tennis (dont il dérive) et particulièrement apprécié pour ses règles simples et pour sa capacité à créer une agrégation entre personnes de tous âges. C'est le sport du moment : immédiat et ludique, il est véritablement à la portée de tous. Le terrain est bordé sur 4 côtés par des murs sur lesquels la balle peut rebondir, tout en restant toujours en jeu, et pour le pratiquer il suffit d'avoir une raquette en bois, qui dans le jargon technique s'appelle une " pelle ".Le nom padel dérive de l'espagnol pàdel , qui signifie pagaie , terme utilisé au début pour désigner les raquettes en bois utilisées pour jouer. La balle qui frappe est extérieurement impossible à distinguer d'une balle de tennis, mais a en fait une pression interne légèrement moindre pour limiter son rebond et permettre aux joueurs plus de contrôle sur le tir.

Au total, il doit y avoir 4 joueurs, et la balle ne peut rebondir qu'une seule fois sur le sol avant de pouvoir être frappée : attention cependant, car les murs utilisables sont uniquement ceux de votre propre terrain, et vous devez éviter de heurter le grillage et les murs du terrain adverse. Mais… à quel point ce sport est-il exigeant d'un point de vue physique ? Concrètement, qu’implique un match de padel ? Comment manger pour mieux préparer un match ?

Combien est consommé en jouant au padel Le padel, comme le tennis et tous les sports de "raquette", est une activité considérée comme aérobie. Elle permet de tonifier le corps et les muscles, devenant certainement l'une des activités qui garantissent une consommation calorique élevée. En réalité, métaboliquement parlant, c'est un sport mixte : en effet, des engagements différents et alternés sont demandés au corps, tant aérobies qu'anaérobies. Sprints, battements, freinages, changements de direction : un match de padel nécessite une composante importante à la fois de force et d'énergie musculaire.

## Entraînement spécifique

En moyenne, un joueur de padel consomme entre 600 et 700 kcal par heure (et on ne parle pas de joueurs de haut niveau), brûlant même jusqu'à 1000 kcal pour une heure et demie de match. La consommation est inférieure à celle estimée pour la course à pied et la natation, mais elle est comparable à celle d'un cycliste pédalant à une vitesse moyenne de 25 km/h. De plus, grâce aux brusques augmentations d'intensité alternant avec des moments de récupération, dues au caractère intermittent des rythmes qui régissent chaque jeu, l'effet EPOC (Excess Post Exercise Oxygen Consumption) est également stimulé. Laissant de côté un instant le monde des professionnels, où l'athlète individuel est toujours suivi par une équipe d'experts et son nutritionniste, essayons de comprendre ensemble comment ces athlètes peuvent faire le saut en qualité, en améliorant et en optimisant leurs performances pour l'emporter même sur les adversaires les plus redoutables.

Grâce à un apport correct en nutriments, nous pouvons en effet fournir à notre corps tout ce dont il a besoin pour être réactif, performant et résistant à la fatigue. Mais ce que nous mangeons n'est pas seulement important : il ne faut pas non plus sous-estimer le moment. En fonction du temps dans lequel nous entendons affronter notre jeu, la stratégie nutritionnelle peut varier, en gardant toujours à l'esprit quelques conseils pratiques, que nous énumérons ci-dessous. Que privilégier et que limiter Après avoir examiné les 3 « règles de base » de l'alimentation du joueur de padel, comprenons quels aliments sont recommandés et lesquels doivent être limités.

Avant de souligner un aliment spécifique, il est bon de rappeler qu'il est toujours déconseillé de jouer le ventre plein. Si la digestion est en cours, le sang se concentre dans l'estomac pour compléter ce processus, ne parvenant ainsi pas à alimenter suffisamment les muscles impliqués dans l'activité. Le bon repas pour chaque instant du jour du match Nous laissons ci-dessous quelques exemples de repas ou de collations idéaux à consommer stratégiquement en fonction du moment de notre partie. Si je joue au padel le matin ?

## Nutrition du joueur

Le petit-déjeuner doit se terminer au moins une heure et demie avant le match. Mieux vaut choisir des aliments riches en sucre et faciles à digérer : biscottes avec de la confiture, fruits de saison, céréales soufflées et éviter le lait. Les graisses et les protéines provoquent en effet des lourdeurs digestives. Si je joue à midi ?

Je peux conserver un petit-déjeuner basique (comme celui recommandé précédemment) ou l'intégrer et le compléter. Du porridge, des crêpes ou du yaourt avec du granola sont un bon choix. Mais pensez aussi au goûter du milieu de la matinée, pour ne pas vous lancer dans le match sans énergie : galettes de maïs, fruits frais ou toasts. Si je joue l'après midi ?

Si vous jouez juste après avoir mangé, pensez à remplacer votre collation du matin par un déjeuner léger (une assiette de pâtes ou de riz avec des fruits sont d'excellentes alternatives). Si, par contre, vous devez attendre en fin d'après-midi, il est conseillé de déjeuner par un repas complet plus copieux, avec de la viande blanche ou du poisson, et d'ajouter une collation (équivalente à celle du milieu de la matinée) même en milieu d'après-midi. Si je joue le soir ? Toutes les indications données pour les repas précédents s'appliquent, rendant la collation de l'après-midi plus abondante, ajoutant ainsi du pain, du chocolat et des fruits.

## Récupération

Si nous voulons être sûrs d'être en pleine forme pour battre nos amis ou nos adversaires, l'intégration peut également nous donner un avantage. Nous listons ci-dessous quelques extraits ou suppléments de plantes qui peuvent nous garantir le soutien nécessaire pour toujours tirer le meilleur parti de chaque match. Accessibilité, simplicité de jeu, nécessité de trouver un espace pour se défouler, partager et s'amuser : le padel a une grande emprise sur les athlètes de tous âges. On ne peut pas savoir si cela restera seulement la tendance du moment ou si dans le futur nous le verrons aux JO, mais une chose est sûre : le nombre de fans augmente de jour en jour et ils n'ont qu'une seule préoccupation : pouvoir trouver un terrain libre pour jouer.

Courel-Ibáñez J, Sánchez-Alcaraz Martinez BJ, Muñoz Marín D.Explorer la dynamique du jeu au padel : implications pour l'évaluation et l'entraînement.J Strength Cond Res.2019 Jul ; 33 (7) : 1971-1977.doi : 10.1519 / JSC.0000000000002126.PMID : 28723819. Demeco A, de Sire A, Marotta N, Spanò R, Lippi L, Palumbo A, Iona T, Gramigna V, Palermi S, Leigheb M, Invernizzi M, Ammendolia A.Analyse de match, entraînement physique, risque de blessure et rééducation au padel : aperçu de la littérature.Int J Environ Res Public Health.2022 mars 31;19(7):4153.doi: 10.3390/ijerph19074153.PMID: 35409836; PMCID : PMC8998509. Tarnopolsky MA.Utilisation de la caféine et de la créatine dans le sport.Ann Nutr Metab.2010;57 Suppl 2:1-8.doi : 10.1159/000322696.Epub 22 février 2011.PMID : 21346331. Shabir A, Hooton A, Tallis J, F Higgins M.

L'influence des attentes en matière de caféine sur le sport, l'exercice et les performances cognitives. Nutrients.2018 17 octobre; PMCID : PMC6212857. Volpe SL.Magnesium and the Athlete.Curr Sports Med Rep.2015 Jul-Aug;14(4):279-83.doi: 10.1249/JSR.0000000000000178.PMID: 26166051. Wang R, Chen C, Liu W, Zhou T, Xun P, He K, Chen P.

L'effet de la supplémentation en magnésium sur la forme musculaire : une méta-analyse et une revue systématique. Magnes Res.2017 1er novembre;30(4):120-132.doi : 10.1684/mrh.2018.0430.PMID : 29637897. Di Lorenzo C, Dell'Agli M, Badea M, Dima L, Colombo E, Sangiovanni E, Restani P, Bosisio E.Compléments alimentaires végétaux aux propriétés anti-inflammatoires : une revue systématique (II).Crit Rev Food Sci Nutr.2013 ; 53 (5) : 507-16.doi : 10.1080 / 10408398.2012.691916.PMID : 23391017. Lugo JP, Saiyed ZM, Lane NE.Efficacité et tolérabilité d'un supplément de collagène non dénaturé de type II dans la modulation des symptômes de l'arthrose du genou : une étude multicentrique randomisée, en double aveugle et contrôlée par placebo.Nutr J.2016 29 janvier;15:14.doi : 10.1186/s12937-016-0130-8.PMID : 26822714 ; PMCID : PMC4731911.
...
---`,
  ...
  {
    id: `yam-26`,
    slug: `yam-physiology-nd-nutrition-of-ltitude-training-93`,
    title: `Physiologie et nutrition de l'entraînement en altitude`,
    excerpt: `Pour les athlètes d'endurance, les températures extrêmes et l'altitude peuvent affecter les réponses physiologiques normales à l'exercice et, dans certains cas, les performances sportives s'en trouvent affectées. Bien que les preuves scientifiques...`,
    content: `# Physiologie et nutrition de l'entraînement en altitude
...
Eur J Appl Physiol 2009 ; 106 : 599-604. Gore CJ. Le défi de l'évaluation des performances des athlètes après un entraînement en altitude. J Appl Physiol 2014 ; 116 : 593-4.
...
Int J Sports Med 26 : 350-355. Gore CJ, Sharpe K, Garvican-Lewis LA, Saunders PU, Hum-berstone CE, Robertson EY, Wachsmuth NB, Clark SA, McLean BD, Friedmann-Bette B, Neya M, Pottgiesser T, Schumacher YO et Schmidt WF. (2013). Entraînement en altitude et masse d'hémoglobine à partir de la méthode optimisée de réinspiration au monoxyde de carbone déterminée par une méta-analyse.Br J Sports Med 47 : i31-39. Kelly GS. (2001).

Rhodiola rosea : Un adaptogène végétal possible. Altern Med Rev 6 : 293-302. Koh JH, Kim KM, Kim JM, Song JC et Suh HJ. (2003). Effet antifatigue et antistress de la fraction d'eau chaude des mycéliums de Cordyceps sinensis.

Biol Pharm Bull 26 : 691-694. Chiou WF, Chang PC, Chou CJ et Chen CF. (2000). Le constituant protéique contribue aux activités hypotensives et vasorelaxantes du Cordyceps sinensis. Life Sci 66 : 1369-1376.

Lang JA, Krajek AC, Schwartz KS, Rand JE. La supplémentation orale en L-Tyrosine améliore le maintien de la température centrale chez les personnes âgées. Med Sci Sports Exerc. 2020 avril;52(4):928-934.
...
---`,
  ...
  {
    id: `yam-27`,
    slug: `yam-how-to-deal-with-psychophysical-work-nd-emotional`,
    title: `Comment gérer le stress psychophysique, professionnel et émotionnel`,
    excerpt: `La vie moderne dans les pays les plus avancés est souvent très stressante et implique un engagement continu en faveur de la compétitivité dans tous les secteurs de la vie, à commencer par le travail. Être efficace et productif est une exigence...`,
    content: `# Comment gérer le stress psychophysique, professionnel et émotionnel

## Sources de stress moderne

La vie moderne dans les pays les plus avancés est souvent très stressante et implique un engagement continu en faveur de la compétitivité dans tous les secteurs de la vie, à commencer par le travail. Être efficace et productif est une exigence difficile à satisfaire à tout moment, et suivre le rythme n'est pas facile. Ensuite, il y a des périodes de stress psychophysique, de travail, émotionnel ou d'études intenses, où vous avez besoin d'aide pour être plus performant et concentré sur le plan cognitif, ou d'une plus grande brillance et réactivité mentale. Il existe une gamme de substances naturelles à haute énergie adaptogène-nootropique, substances reconnues depuis toujours : Bacopa Monnieri, Panax Ginseng et Ginko Biloba.

À partir du pool savamment calibré de ces éléments, il est possible d'obtenir des compléments alimentaires « adaptogènes » avec des caractéristiques marquées et des éléments qui les rendent également définissables comme « nootropiques ». Le Bacopa Monnieri est considéré par de nombreux experts comme la meilleure substance naturelle nootropique connu sur le marché, dont les bénéfices sont déjà évidents dans la médecine ayurvédique comme un puissant tonique de soutien pour les phases de stress psychophysique particulier, capable de réduire les états d'anxiété, d'améliorer l'humeur, la mémoire et les temps de réaction, grâce à son effet rééquilibrant sur les neurotransmetteurs tels que l'acétylcholine. calme. Le Ginseng est l'une des herbes médicinales les plus populaires au monde, transmise depuis le Médicaments orientaux ou nord-américains anciens depuis des siècles, très riches en substances bioactives, où ils se distinguent parmi tous les "ginsénosides". Des recherches cliniques approfondies ont rapporté son efficacité comme l'un des principaux adaptogènes et substances "anti-stress" qui améliorent la capacité cognitive, la mémoire, combattent la fatigue, la circulation, la digestion, agissant comme immunomodulateur, antioxydant et récemment comme soutien dans la ménopause ou la dysfonction érectile.

## Impact sur la santé

Mais parmi les nombreuses vertus du ginseng, comme nous le trouvons aujourd'hui comme un nootropique naturel important élément, car il améliore la capacité de l'organisme à faire face aux phases de stress physique et psychologique, en lui donnant plus d'énergie et en réduisant la fatigue adrénergique.Puissant neuroprotecteur contre la dopamine. Le Ginko Biloba est une plante médicinale dont la présence sur Terre remonte à des millénaires, dont utilisé dans la médecine traditionnelle chinoise depuis 2800 avant JC, on le trouve déjà recommandé pour l'asthme, la toux, les troubles vasculaires et comme tonique pour contraster le vieillissement. Aujourd'hui bien connu dans le monde des nutraceutiques, il est considéré pour rééquilibrer les neurotransmetteurs, ralentir la dégénérescence des cellules cérébrales, améliorer la circulation cérébrale fournissant ainsi un plus grand flux d'oxygène et de glucose disponible aux neurones. Le Ginko Biloba est l'une des substances naturelles les plus appropriées pour stimuler l'apprentissage, la mémoire et les capacités cognitives en général.

Favorise l'augmentation de la dopamine dans le cerveau, réduisant l'anxiété et améliorant la motivation. Calabrese N.D., Gregory W.L., Leo M., Kraemer D., Bone K., Oken B. « Effets d'un extrait standardisé de Bacopa monnieri sur les performances cognitives, l'anxiété et la dépression chez les personnes âgées : un essai randomisé, en double aveugle et contrôlé par placebo » Journal of Alternative and Complimentary Medicine 2008 juillet ; 14(6) : 707-713. Aguiar S, Borowski T. Examen neuropharmacologique de l'herbe nootropique Bacopa monnieri.

## Gestion au quotidien

PMCID : PMC3746283. Stough C., Lloyd J., Clarke J., Downey L.A., Hutchison C.W., Rodgers T., Nathan P.J. « Les effets chroniques d'un extrait de Bacopa monniera (Brahmi) sur la fonction cognitive chez des sujets humains en bonne santé. » Psychopharmacologie 2001 août;156(4):481-4.Stough C., Downey L.A., Lloyd J., Silber B., Redman S., Hutchison C., Wesnes K., Nathan P.J. « Examen des effets nootropiques d'un extrait spécial de Bacopa monniera sur le fonctionnement cognitif humain : essai randomisé en double aveugle contrôlé par placebo de 90 jours. » Phytotherapy Research 2008 Dec;22(12):1629-34 Bhattacharya S.K., Ghosal S. « Activité anxiolytique d'un extrait standardisé de Bacopa monniera : une étude expérimentale. » Phytomédecine.1998 avril;5(2):77-82 Nemetchek MD, Stierle AA, Stierle DB, Lurie DI. La plante ayurvédique Bacopa monnieri inhibe les voies inflammatoires dans le cerveau. PMID : 27473605 ; PMCID : PMC5269610.

Sukumaran NP, Amalraj A, Gopi S. Effets neuropharmacologiques et cognitifs de Bacopa monnieri (L.) Wettst - Une revue sur ses aspects mécanistiques. 31126578. Li X.T., Chen R., Jin L.M., Chen H.Y. « Régulation du métabolisme énergétique et protection des mitochondries du polysaccharide Panax ginseng. » Journal américain de médecine chinoise.2009;37(6):1139-52. Baeg I.H., So S.H. « Le marché mondial du ginseng et le ginseng (Corée) » Journal of Ginseng Research, mars 2013 ; 37(1) : 1-7.
...
---`,
  ...
  {
    id: `yam-28`,
    slug: `yam-the-secret-of-youthfulness-for-quality-geing-97`,
    title: `Le secret de la jeunesse pour un vieillissement de qualité`,
    excerpt: `La réponse pour nous est très simple : pouvoir vivre pleinement chaque instant de la vie. Et comment vivre pleinement chaque jour ? Prendre soin de sa santé, car notre façon de vivre fait vraiment la différence. En fait, le grand défi de la...`,
    content: `# Le secret de la jeunesse pour un vieillissement de qualité

## Le vieillissement biologique

La réponse pour nous est très simple : pouvoir vivre pleinement chaque instant de la vie. Et comment vivre pleinement chaque jour ? Prendre soin de sa santé, car notre façon de vivre fait vraiment la différence. En fait, le grand défi de la médecine de notre époque est de faire coïncider l'espérance de vie avec l'espérance de vie active, c'est-à-dire nous permettre de vivre en même temps longtemps et en bonne santé, en prévenant les pathologies qui caractérisent la vieillesse et qui ne nous permettent pas « d'agir », d'effectuer toutes les activités fondamentales pour l'homme liées aux conditions générales d'existence et au maintien des fonctions physiques et cognitives.

Il faut donc prêter attention à la qualité de notre vieillissement (tant interne qu'externe). Lorsque nous parlons de vieillissement cutané, nous entendons un processus biologique complexe résultant de deux mécanismes synergiques : des facteurs intrinsèques et extrinsèques. D'une part, le vieillissement intrinsèque ou endogène est un phénomène inévitable qui comprend plusieurs facteurs, tels que le métabolisme cellulaire, la génétique, les hormones et le passage du temps : ce type de vieillissement est celui cliniquement associé à une plus grande fragilité des os et des tissus et à une perte d'élasticité. causées par une exposition répétée de la peau ou du corps à des agents nocifs, notamment aux rayons UV (photo-vieillissement), à une alimentation inappropriée et non réglementée, à la pollution, aux produits chimiques et aux toxines [ 1,2]. Il a été démontré que divers ingrédients d'origine naturelle sont potentiellement efficaces pour réduire les signes du vieillissement cutané, prévenir les problèmes cutanés et l'apparition de troubles et pathologies (3,4,5).  nous verrons comment la prise de nutraceutiques à titre préventif peut réellement être la clé pour bien vieillir.

Que se passe-t-il réellement en vieillissant À la base du vieillissement de toutes nos cellules se trouvent 3 mécanismes naturels et physiologiques, que chaque jour notre corps met en place pour fonctionner de manière optimale. Ces processus, lorsqu'ils sont présents en quantité suffisante, ont des effets positifs sur nos vies : au fil des années, cependant, l'équilibre qui les caractérise change, conduisant à un déséquilibre qui provoque par conséquent des dommages et une accélération des processus de vieillissement. Agir sur notre mode de vie, avec une approche intégrée entre alimentation, entraînement et supplémentation, peut ralentir ces mécanismes, nous permettant de profiter du temps qui passe en bonne santé (et pourquoi pas, visuellement plus beau !). Pourquoi l'intégration fait une différence (à long terme) Dans le monde dans lequel nous vivons, il est malheureusement facile d'être exposé à des carences en micronutriments.

Les aliments que nous consommons quotidiennement, souvent ultra-transformés, sont en effet riches en calories mais pauvres en nutriments. Cela ne veut pas dire que nous remarquerons immédiatement une différence : ne pas avoir le scorbut ne signifie pas avoir des apports optimaux en vitamine C. Les véritables maladies de carence n'existent plus (sauf dans certaines régions du monde), mais cela ne conduit pas automatiquement à la pleine santé. En effet, nous avons tendance à associer la santé à l'absence de maladie, mais la réalité est qu'il s'agit de quelque chose de plus.
...
Manolagas SC.De l'œstrogène centré au vieillissement et au stress oxydatif : une perspective révisée de la pathogenèse de l'ostéoporose.Endocr Rev.2010 ; 31 : 266-300. Iwamoto J, Takeda T, Ichimura S.Effet de l'administration combinée de vitamine D3 et de vitamine K2 sur la densité minérale osseuse de la colonne lombaire chez les femmes ménopausées atteintes d'ostéoporose.J Orthop Sci.2000 ; 5 : 546-51. Salari P, Rezaie A, Larijani B, Abdollahi M. Une revue systématique de l'impact des acides gras n-3 sur la santé osseuse et l'ostéoporose.

Med Sci Monit.2008 ; 14 : 37-44. Alamdari N, O'Neal P, Hasselgren PO. Curcumine et fonte musculaire : un nouveau rôle pour un vieux médicament ? Nutrition.2009 ; 2 : 125-9
