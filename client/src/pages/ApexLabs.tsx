...
const OFFERS: Offer[] = [
  {
    ...
    description: "Ton premier diagnostic métabolique gratuit — un aperçu puissant de ton état de santé à travers 5 piliers essentiels. 50 questions ciblées (15-20 min), et tu reçois un dashboard interactif avec ton radar de performance, ton score global sur 100, et tes 3 blocages prioritaires identifiés. C'est comme une prise de sang gratuite, mais pour TOUTE ta santé.",
  ...
  },
  {
    ...
    subtitle: "Mon Best-Seller",
    description: "L'audit métabolique complet — celui que je faisais en coaching one-to-one à 300€/mois. 150 questions (35-40 min) qui décortiquent ta nutrition réelle, ton profil hormonal (homme/femme), tes axes cliniques (thyroïde, intestin, glycémie), et tes suppléments. Tu reçois un rapport PDF de ~25 pages avec protocoles matin/soir, stack suppléments personnalisé, et plan d'action 90 jours.",
    features: ["Rapport PDF ~25 pages (17 sections)", "Protocoles matin & soir personnalisés", "Stack suppléments sur-mesure", "Plan d'action 90 jours"],
    price: "49€",
  ...
  },
  {
    ...
    description: "Tu as un bilan sanguin ? Envoie-le moi. J'analyse CHAQUE marqueur avec mes ranges optimaux de performance — pas les ranges « normaux » des labos qui sont trop larges. Thyroïde, hormones, métabolisme, inflammation, vitamines, foie, reins... Je te dis exactement ce que ton sang révèle et comment corriger chaque déséquilibre. Rapport de 10-15 pages avec protocoles correctifs.",
    features: ["Analyse de 50+ biomarqueurs", "Ranges optimaux (pas labos)", "Détection syndromes cachés", "Protocoles correctifs ciblés"],
    price: "99€",
    imageUrl: "",
    reverse: false,
  ...
  },
  {
    ...
    description: "L'audit le plus complet du marché francophone. 210 questions + sync de tes wearables (Oura, Apple Watch, Garmin...) + analyse de tes 3 photos (posture, composition corporelle). Je révise PERSONNELLEMENT ton rapport. Tu reçois ~45 pages avec 25+ sections : HRV, cardio, psychologie, biomécanique, nutrition timing, et un dashboard temps réel avec alertes automatiques.",
    features: ["Rapport ~45 pages (25+ sections)", "Analyse photo posture & composition", "Sync wearables temps réel", "Support prioritaire 24h"],
    price: "99€",
  ...
  },
  {
    ...
    description: "Je détecte ton risque de burnout AVANT qu'il soit trop tard. 80 questions ciblées (20-25 min) sur ta charge nerveuse, sommeil, symptômes physiques et psychologiques. Tu reçois un score de risque (0-100), ta phase de burnout (1 à 5), et un protocole de récupération de 4 semaines si tu es en zone rouge. Parce que les gens en burnout n'ont plus le budget pour 100€.",
