  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black pt-16">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-cyan-500/5 rounded-full blur-[120px]"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.1, 0.3, 0.1],
          }}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              180+ questions. 16 sections d'analyse.
              Protocoles personnalisés basés sur 11 certifications internationales.
            </motion.p>
            ...
            >
              ...
              <p className="mt-4 text-sm text-gray-600">
                Offre exclusive réservée aux premiers inscrits.
              </p>
            </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              >
                <motion.div
                  className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-cyan-400 rounded-full"
              ...
              >
                <motion.div
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-2 h-2 bg-emerald-400 rounded-full"
                />
              </motion.div>
...
function OffersPreview() {
  const offers = [
    {
      name: "Discovery Scan",
      description: "Diagnostic complet de tes blocages",
      icon: Scan,
    },
    {
      name: "Anabolic Bioscan",
      description: "16 sections + protocoles personnalisés",
      icon: Activity,
    },
    {
      name: "Ultimate Scan",
      description: "Analyse visuelle + biomécanique",
      icon: Zap,
      featured: true,
    },
    {
      name: "Blood Analysis",
      description: "Ton bilan sanguin décodé",
      icon: Droplet,
    },
    {
      name: "Burnout Engine",
      description: "Détection + protocole récupération",
      icon: Brain,
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <p className="text-xs uppercase tracking-[0.3em] text-emerald-500 mb-4">
            5 Scans disponibles au lancement
          </p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            Du diagnostic à l'optimisation complète
          </h2>
        </motion.div>
              ...
              >
                {offer.featured && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="bg-emerald-500 text-black text-[10px] font-semibold px-3 py-1 rounded-full uppercase tracking-wider">
                      Populaire
                    </span>
                  </div>
                )}
...
function AchzodSection() {
  const certifications = [
    "NASM-CPT", "NASM-CNC", "NASM-PES",
    "ISSA-CPT", "ISSA-SNS", "ISSA-SFC",
    "Precision Nutrition PN1", "Pre-Script L1"
  ];
    ...
    <section className="py-32 bg-gradient-to-b from-black to-gray-950">
      <div className="mx-auto max-w-4xl px-6 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-xs uppercase tracking-[0.3em] text-gray-600 mb-8">
            Créé par
          </p>
          ...
          <p className="text-lg text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Coach certifié avec plus de 11 certifications internationales.
            Des années d'expérience à accompagner des clients en coaching individuel,
...
function FinalCTA() {
  ...
  return (
    <section className="relative py-32 bg-gray-950 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-2xl px-6 text-center">
        ...
        >
          ...
          <p className="text-gray-500 mb-10">
            Offre de lancement exclusive réservée à la liste VIP.
          </p>
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="h-14 px-8 bg-emerald-500 hover:bg-emerald-400 text-black font-semibold rounded-full transition-all flex items-center justify-center gap-2"
              >
      ...
      {/* Footer */}
      <div className="mt-20 text-center text-sm text-gray-700">
        ApexLabs by Achzod
      </div>
    </section>
  );
