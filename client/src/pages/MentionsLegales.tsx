      ...
      <main className="container mx-auto max-w-4xl px-4 pb-24">
        <div className="space-y-10">
          ...
          <div className="rounded-sm border border-[#FCDD00]/30 bg-[#FCDD00]/5 p-6 md:p-8">
            <p className="font-mono text-[10px] text-[#FCDD00] uppercase tracking-[0.2em] mb-4">[ EDITEUR DU SITE ]</p>
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 1 - Informations Legales</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
            ...
            <div className="mt-6 rounded-sm border border-neutral-800 bg-black p-4">
              <p className="font-light text-neutral-400">
            ...
            <div className="mt-4 rounded-sm border border-neutral-800 bg-black p-4">
              <p className="font-light text-neutral-400">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 2 - Accessibilite</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 3 - Collecte de Donnees et Loi Informatique et Libertes</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 4 - Politique de Cookies</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 5 - Clause de Non-Responsabilite</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 6 - Loi Applicable et Juridiction</h2>
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 7 - Contact</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
