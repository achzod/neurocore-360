    ...
    <div ref={containerRef} className="bg-[#050505] min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <span className="text-[#FCDD00] text-[10px] font-mono uppercase tracking-[0.2em]">[ MOST COMPLETE ]</span>
          </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="text-cyan-400 text-[10px] font-mono tracking-[0.2em] uppercase mb-6">
              Triple Source
            </p>
            <h2 className="text-white text-3xl font-bold tracking-tight uppercase">
              3 sources de donnees.
              <br />
              <span className="text-neutral-400 font-light">Precision maximale.</span>
            </h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="relative overflow-hidden rounded-sm bg-black border border-neutral-800 p-10 hover:border-cyan-500/30 transition-all duration-300 group"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {sections.map((section, i) => (
              <motion.div
                ...
                className="group rounded-sm bg-black border border-neutral-800 p-4 hover:border-cyan-500/30 transition-all duration-300"
              >
            ...
            >
              <div className="aspect-square rounded-sm bg-gradient-to-br from-purple-500/20 to-transparent border border-neutral-800 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-neutral-500 font-light text-lg">4 photos analysees par IA</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {wearables.map((device, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="px-6 py-4 rounded-sm border border-neutral-800 bg-black text-neutral-400 font-light hover:border-[#FCDD00]/30 hover:text-white transition-all"
              >
                {device}
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="lg:col-span-2 lg:row-span-2 relative overflow-hidden rounded-sm bg-gradient-to-br from-cyan-500/10 to-transparent border border-neutral-800 p-10"
            >
              <div className="relative z-10">
                <p className="text-cyan-400 text-[10px] font-mono tracking-[0.2em] uppercase mb-4">Rapport Complet</p>
            ...
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="rounded-sm bg-black border border-neutral-800 p-8 hover:border-cyan-500/20 transition-all duration-300"
              >
      ...
      <section className="py-32 px-6 border-t border-neutral-800">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-sm border border-cyan-500/30 bg-gradient-to-b from-cyan-500/10 to-transparent p-10 shadow-[0_0_60px_rgba(34,211,238,0.1)]"
          >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              >
                {plan.current && (
                  <div className="text-cyan-400 text-[10px] font-mono tracking-[0.2em] uppercase mb-4">
                    Tu es ici
                  </div>
                )}
