      ...
      <section className="relative z-10 bg-[#0a0a0a] py-24 px-6">
        <div className="mx-auto max-w-5xl">
          ...
          <AnimatedReportPreview
            score={72}
            scoreColor="#FCDD00"
            urlBar="apexlabs.achzodcoaching.com/ultimate/rapport-demo"
            panels={[
              { name: "Posture", score: 68 },
              { name: "Biomecanique", score: 71 },
              { name: "Entrainement", score: 82 },
              { name: "Cardio", score: 77 },
              { name: "Metabolisme", score: 76 },
              { name: "Sommeil", score: 55 },
              { name: "Digestion", score: 78 },
              { name: "Hormones", score: 85 },
            ]}
            alert={{
              title: "Antéversion bassin detectee",
              detail: "epaule droite plus haute de 2cm",
            }}
            protocol={{
