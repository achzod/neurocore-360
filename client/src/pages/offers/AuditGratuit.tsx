        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="divide-y divide-white/10">
            {[
              ...
              { q: "Comment est genere mon rapport ?", a: "Ton rapport est genere par mon moteur IA qui croise tes 66 reponses pour identifier les patterns, desequilibres et priorites. Chaque rapport est unique — deux personnes avec des reponses differentes recoivent des analyses completement differentes. Il est disponible en quelques minutes dans ton dashboard." },
            ].map((faq, i) => (
