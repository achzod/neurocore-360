      ...
      <section className="relative z-10 bg-[#0a0a0a] py-24 px-6">
        <div className="mx-auto max-w-5xl">
          ...
          <AnimatedReportPreview
            score={77}
            scoreColor="#FCDD00"
            urlBar="apexlabs.achzodcoaching.com/anabolic/rapport-demo"
            panels={[
              { name: "Entrainement", score: 82 },
              { name: "Cardiovasculaire", score: 77 },
              { name: "Metabolisme", score: 71 },
              { name: "Sommeil", score: 55 },
              { name: "Digestion", score: 78 },
              { name: "Hormones", score: 85 },
            ]}
            alert={{
              title: "Sommeil: score 55/100",
              detail: "recuperation insuffisante, cortisol eleve le soir",
            }}
            protocol={{
            ...
            extras={[
              {
                ...
                detail: "Magnesium 300mg, Ashwagandha 600mg, Zinc 30mg",
              },
            ]}
          />
        </div>
