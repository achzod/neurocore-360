          ...
          >
            <Card>
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-center gap-2 rounded-md border border-primary bg-primary/10 px-4 py-3 text-sm font-medium text-primary ring-1 ring-primary">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  {selectedPlan === "gratuit"
                    ...
                    : selectedPlan
                    ? "Tu seras redirigé vers le paiement sécurisé par carte."
