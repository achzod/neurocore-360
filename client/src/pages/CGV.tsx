    ...
    <div className="min-h-screen bg-[#050505]">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-4xl px-4 text-center">
          <motion.p
            ...
            className="font-mono text-[10px] text-[#FCDD00] uppercase tracking-[0.2em] mb-6"
          >
            [ CGV ]
          </motion.p>
          <motion.h1
            ...
            className="text-white text-5xl sm:text-6xl md:text-7xl font-black tracking-tighter uppercase"
          >
      ...
      <main className="container mx-auto max-w-4xl px-4 pb-24">
        <div className="space-y-10">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 1 - Champ d'application</h2>
            ...
            <p className="mt-3 font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-black border border-neutral-800 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 2 - Description des Services</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 3 - Deduction sur les Coachings</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
            ...
            <ul className="mt-4 space-y-2 font-light text-neutral-400">
            ...
            <p className="mt-4 font-light text-neutral-400 leading-relaxed">
              La deduction est valable pendant 12 mois a compter de la date d'achat de l'audit.
            </p>
          </section>

          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 4 - Commandes</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 5 - Prix et Paiement</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 6 - Livraison</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm border border-red-500/30 bg-red-500/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-red-400">Article 7 - Politique de Non-Remboursement</h2>
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 8 - Acceptation du Client</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 9 - Propriete Intellectuelle</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 10 - Responsabilite</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 11 - Protection des Donnees</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <section className="rounded-sm bg-white/[0.03] border border-white/10 p-6 md:p-8">
            <h2 className="mb-4 text-3xl font-bold tracking-tight uppercase text-white">Article 12 - Droit Applicable</h2>
            <p className="font-light text-neutral-400 leading-relaxed">
          ...
          <div className="rounded-sm border border-[#FCDD00]/30 bg-[#FCDD00]/5 p-6 md:p-8">
            <p className="font-mono text-[10px] text-[#FCDD00] uppercase tracking-[0.2em] mb-4">[ CONTACT ]</p>
