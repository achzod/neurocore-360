...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    price: "4.99€",
    period: "1er mois",
    description: "Analyse biomécanique de tes exercices par vidéo WhatsApp. 15 analyses/mois.",
    badge: "NOUVEAU",
    features: [
      ...
      { text: "15 analyses par mois", included: true },
      { text: "100% via WhatsApp", included: true },
      { text: "Puis 14.99€/mois", included: true },
