...
export const PRICING_PLANS = [
  ...
  },
  {
    ...
    price: 99,
    priceLabel: "99€",
    subtitle: "Paiement unique · 2 analyses",
    description: "2 crédits utilisables quand tu veux pour comparer tes bilans",
    icon: "Beaker",
    color: "red",
    href: "/offers/blood-analysis",
    features: [
      "2 crédits Blood Analysis sans expiration",
  ...
  },
  {
    ...
    priceLabel: "79€",
    subtitle: "Paiement unique",
    description: "Anabolic Bioscan + analyse posturale + blessures",
    icon: "Zap",
    color: "cyan",
