...
const PHOTO_ANALYSIS_PROMPT = `Tu es un expert kinesitherapeute et coach certifie. Analyse ces photos corporelles avec precision.
...

{
  "fatDistribution": {
    ...
    "zones": ["liste max 4 zones stockage principales"],
    "estimatedBF": "XX-XX%",
    "waistToHipRatio": "0.XX (androide/gynoide)"
  },
  "posture": {
    "headPosition": "phrase courte",
    "shoulderAlignment": "phrase courte",
    "spineAlignment": "phrase courte",
    "pelvicTilt": "phrase courte",
    "kneesAlignment": "phrase courte",
    "overallScore": 0-100,
    "issues": ["max 3 problemes principaux"]
  },
  "muscularBalance": {
    "upperBody": "phrase courte",
    "lowerBody": "phrase courte",
    "leftRightSymmetry": "phrase courte",
    "anteriorPosterior": "phrase courte",
    "weakAreas": ["max 3"],
    "strongAreas": ["max 3"]
  },
  "medicalObservations": {
    "skinCondition": ["max 2"],
    "edemaPresence": "phrase courte",
    "vascularSigns": ["max 2"],
    "potentialConcerns": ["max 2"]
  },
  "recommendations": {
    "posturalCorrections": ["3 exercices PRECIS"],
    "muscleGroupsToTarget": ["3 groupes prioritaires"],
    "mobilityWork": ["2 exercices mobilite"],
    "medicalFollowUp": ["si necessaire"]
  },
  "summary": "Synthese en 2-3 phrases max",
  "confidenceLevel": 70-100
}

REGLES : Sois PRECIS et CONCIS. Remplis CHAQUE champ. JSON valide uniquement.`;
