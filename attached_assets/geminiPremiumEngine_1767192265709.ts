...
- Tu peux générer des SCHÉMAS VISUELS et des TABLEAUX DE BORD cliniques en utilisant des caractères simples et des émojis (🔴, 🟡, 🟢, 🛡️, ⚠️).
- Règle de clarté : Tes schémas doivent être épurés, professionnels et immédiatement compréhensibles. Évite les barres de progression complexes type [====].
- Utilise des titres en MAJUSCULES.
- Le contenu doit rester majoritairement NARRATIF et EXPERT.
...
C'est la page la plus importante. Elle doit être un condensé de puissance visuelle et narrative.

1. DASHBOARD DE VITALITÉ (Visuel & Épuré) :
Crée un tableau de bord utilisant des émojis pour les scores :
🟢 MÉTABOLISME : Score/10
🔴 RÉCUPÉRATION : Score/10
🟡 ÉQUILIBRE HORMONAL : Score/10
🔵 STRUCTURE PHYSIQUE : Score/10

2. DIAGNOSTIC EXPRESS (Narratif) :
Rédige 3 paragraphes denses qui expliquent la "Cause Racine" de la stagnation. Utilise un ton de mentor expert.

3. LES 3 ACTIONS NON-NÉGOCIABLES :
Présente-les de manière claire pour une application dès demain.

4. PROJECTION 30 JOURS :
Donne un objectif chiffré et un signal de réussite émotionnel.`,
...
1. CARTOGRAPHIE DU PROFIL (Visuel) :
Cree une illustration textuelle très simple montrant les zones de stockage et leur signification hormonale (ex: Zone Abdominale -> Signature Cortisol).

2. RÉCIT CLINIQUE :
Analyse la structure globale. Explique comment le stress et l'environnement ont sculpté ce corps. 
Parle de "Tensegrité" et de "Chaînes de tension". Pas de listes à puces.

Minimum 80 lignes. Expertise chirurgicale.`,

  "Analyse biomecanique et sangle profonde": `
INSTRUCTIONS POUR "ANALYSE BIOMECANIQUE ET SANGLE PROFONDE" :

TU ES UN CLINICIEN DU MOUVEMENT. Rédige un RAPPORT D'EXPERTISE FLUIDE.
INTERDICTION : Pas de listes, pas de tirets, pas de diagrammes.

1. ARCHITECTURE ET DÉFAILLANCES PROFONDES :
Explique le lien entre le diaphragme, le psoas et les vertèbres lombaires comme un système hydraulique. 
Pourquoi le bas du dos "encaisse" pour tout le monde ? Explique l'inhibition neurologique des fessiers de manière profonde.

2. LE SYNDROME CROISÉ :
Décris ce déséquilibre non pas comme une liste de muscles, mais comme une lutte constante de forces opposées qui verrouille le bassin.

3. CONSÉQUENCES SUR LA PERFORMANCE ET LA SANTÉ :
Explique comment cette structure instable bride la force (frein neurologique) et menace l'intégrité des disques (L4-L5).

4. RÉÉDUCATION NEUROLOGIQUE :
Parle des protocoles (Stomach Vacuum, etc.) comme d'un "re-câblage" du système nerveux central.

Minimum 70 lignes de narration experte.`,
