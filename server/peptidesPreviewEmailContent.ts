...
Les familles, le vrai nombre de molécules, leur prix individuel, la durée et le total rendu sont visibles. Les noms exacts, les dosages, les unités, les fréquences, la reconstitution et les liens d’achat restent réservés à ton analyse Peptides Engine complète. Le calcul vise une marge de 20 % sur le stock, puis tient compte des fenêtres d’utilisation des contenants ouverts afin de ne pas étirer un seul contenant sur plusieurs mois. La livraison est comptée une seule fois pour la commande complète.
