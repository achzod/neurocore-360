...
const CATEGORY_BY_MARKER: Record<string, string> = {
  ...
  zinc: "vitamins",
  vitamine_b6: "vitamins",
  alt: "liver_kidney",
  ast: "liver_kidney",
  ggt: "liver_kidney",
  creatinine: "liver_kidney",
  egfr: "liver_kidney",
  phosphatases_alcalines: "liver_kidney",
  acide_urique: "liver_kidney",
  sodium: "liver_kidney",
  potassium: "liver_kidney",
  chlore: "liver_kidney",
  calcium: "liver_kidney",
  phosphore: "liver_kidney",
  proteines_totales: "liver_kidney",
  albumine: "liver_kidney",
  psa: "hormonal",
  hemoglobine: "hemato",
  hematocrite: "hemato",
